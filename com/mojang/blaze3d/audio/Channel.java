...
public class Channel {
    ...
    private Channel(final int source) {
    ...
    public void setSelfPosition(final Vec3 vec3) {
    ...
    public void attachStaticBuffer(final SoundBuffer soundBuffer) {
        soundBuffer.getAlBuffer().ifPresent(integer -> AL10.alSourcei(this.source, 4105, integer));
    }
    
    public void attachBufferStream(final AudioStream stream) {
        this.stream = stream;
        final AudioFormat audioFormat3 = stream.getFormat();
