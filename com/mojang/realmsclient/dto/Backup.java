...
public class Backup extends ValueObject {
    ...
    public Backup() {
        this.metadata = (Map<String, String>)new HashMap();
        this.changeList = (Map<String, String>)new HashMap();
    }
            ...
            if (jsonObject2.has("metadata")) {
                ...
                for (final Map.Entry<String, JsonElement> entry7 : set5) {
                    if (!((JsonElement)entry7.getValue()).isJsonNull()) {
                        backup3.metadata.put(format((String)entry7.getKey()), ((JsonElement)entry7.getValue()).getAsString());
                    }
                }
            }
        }
