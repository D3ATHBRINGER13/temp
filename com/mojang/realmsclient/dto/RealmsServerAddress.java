...
public class RealmsServerAddress extends ValueObject {
    ...
    public static RealmsServerAddress parse(final String string) {
        ...
        try {
            ...
            realmsServerAddress3.address = JsonUtils.getStringOr("address", jsonObject4, (String)null);
            realmsServerAddress3.resourcePackUrl = JsonUtils.getStringOr("resourcePackUrl", jsonObject4, (String)null);
            realmsServerAddress3.resourcePackHash = JsonUtils.getStringOr("resourcePackHash", jsonObject4, (String)null);
        }
