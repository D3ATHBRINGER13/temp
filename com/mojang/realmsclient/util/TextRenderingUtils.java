...
public class TextRenderingUtils {
    ...
    private static List<Line> insertLinks(final List<String> list1, final List<LineSegment> list2) {
        int integer3 = 0;
        final ArrayList<Line> arrayList4 = (ArrayList<Line>)new ArrayList();
        for (final String string6 : list1) {
            final List<LineSegment> list3 = (List<LineSegment>)new ArrayList();
            final List<String> list4 = split(string6, "%link");
            for (final String string7 : list4) {
                if (string7.equals("%link")) {
                    list3.add(list2.get(integer3++));
                }
                else {
                    list3.add(LineSegment.text(string7));
                }
            }
            arrayList4.add(new Line(list3));
        }
        return (List<Line>)arrayList4;
    }
    ...
    public static List<String> split(final String string1, final String string2) {
        ...
        final List<String> list3 = (List<String>)new ArrayList();
        int integer4;
        int integer5;
