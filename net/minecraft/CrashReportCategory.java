...
public class CrashReportCategory {
    ...
    public CrashReportCategory(final CrashReport d, final String string) {
    ...
    public static String formatLocation(final BlockPos ew) {
        return formatLocation(ew.getX(), ew.getY(), ew.getZ());
    }
    ...
    public CrashReportCategory setDetail(final String string, final CrashReportDetail<String> f) {
        try {
            this.setDetail(string, f.call());
        }
    ...
    public static void populateBlockDetails(final CrashReportCategory e, final BlockPos ew, @Nullable final BlockState bvt) {
        if (bvt != null) {
            e.setDetail("Block", (CrashReportDetail<String>)bvt::toString);
        }
        e.setDetail("Block location", (CrashReportDetail<String>)(() -> formatLocation(ew)));
    }
