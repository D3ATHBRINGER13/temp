...
public class DamagePredicate {
    ...
    public DamagePredicate(final MinMaxBounds.Floats c1, final MinMaxBounds.Floats c2, final EntityPredicate av, @Nullable final Boolean boolean4, final DamageSourcePredicate am) {
        this.dealtDamage = c1;
        this.takenDamage = c2;
        this.sourceEntity = av;
    ...
    public boolean matches(final ServerPlayer vl, final DamageSource ahx, final float float3, final float float4, final boolean boolean5) {
        return this == DamagePredicate.ANY || (this.dealtDamage.matches(float3) && this.takenDamage.matches(float4) && this.sourceEntity.matches(vl, ahx.getEntity()) && (this.blocked == null || this.blocked == boolean5) && this.type.matches(vl, ahx));
    }
    ...
    public static DamagePredicate fromJson(@Nullable final JsonElement jsonElement) {
        ...
        final EntityPredicate av6 = EntityPredicate.fromJson(jsonObject2.get("source_entity"));
        final DamageSourcePredicate am7 = DamageSourcePredicate.fromJson(jsonObject2.get("type"));
        return new DamagePredicate(c3, c4, av6, boolean5, am7);
    }
