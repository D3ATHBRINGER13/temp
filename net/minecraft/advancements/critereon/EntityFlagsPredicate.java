...
public class EntityFlagsPredicate {
    ...
    public boolean matches(final Entity aio) {
        return (this.isOnFire == null || aio.isOnFire() == this.isOnFire) && (this.isSneaking == null || aio.isSneaking() == this.isSneaking) && (this.isSprinting == null || aio.isSprinting() == this.isSprinting) && (this.isSwimming == null || aio.isSwimming() == this.isSwimming) && (this.isBaby == null || !(aio instanceof LivingEntity) || ((LivingEntity)aio).isBaby() == this.isBaby);
    }
    ...
    public JsonElement serializeToJson() {
        ...
        this.addOptionalBoolean(jsonObject2, "is_sneaking", this.isSneaking);
