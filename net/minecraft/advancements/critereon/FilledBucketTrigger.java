...
public class FilledBucketTrigger implements CriterionTrigger<TriggerInstance> {
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        ...
        public static TriggerInstance filledBucket(final ItemPredicate bc) {
            return new TriggerInstance(bc);
        }
