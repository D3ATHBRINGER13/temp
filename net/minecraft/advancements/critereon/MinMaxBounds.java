...
public abstract class MinMaxBounds<T extends Number> {
    ...
    protected static <T extends Number, R extends MinMaxBounds<T>> R fromJson(@Nullable final JsonElement jsonElement, final R bi, final BiFunction<JsonElement, String, T> biFunction, final BoundsFactory<T, R> a) {
    ...
    static {
        ERROR_EMPTY = new SimpleCommandExceptionType((Message)new TranslatableComponent("argument.range.empty", new Object[0]));
        ERROR_SWAPPED = new SimpleCommandExceptionType((Message)new TranslatableComponent("argument.range.swapped", new Object[0]));
    }
