...
public class Game implements RunningGame {
    ...
    public Game(final Minecraft cyc) {
    ...
    public GameSession getCurrentSession() {
        final MultiPlayerLevel dkf2 = this.minecraft.level;
        return (GameSession)((dkf2 == null) ? null : new Session(dkf2, this.minecraft.player, this.minecraft.player.connection));
    }
    
    public PerformanceMetrics getPerformanceMetrics() {
        final FrameTimer zr2 = this.minecraft.getFrameTimer();
        long long3 = 2147483647L;
        long long4 = -2147483648L;
        long long5 = 0L;
        for (final long long6 : zr2.getLog()) {
            long3 = Math.min(long3, long6);
            long4 = Math.max(long4, long6);
            long5 += long6;
        }
        return (PerformanceMetrics)new Metrics((int)long3, (int)long4, (int)(long5 / zr2.getLog().length), zr2.getLog().length);
    }
