...
public abstract class ContainerObjectSelectionList<E extends Entry<E>> extends AbstractSelectionList<E> {
    public ContainerObjectSelectionList(final Minecraft cyc, final int integer2, final int integer3, final int integer4, final int integer5, final int integer6) {
    ...
    public abstract static class Entry<E extends Entry<E>> extends AbstractSelectionList.Entry<E> implements ContainerEventHandler {
        ...
        @Override
        public void setFocused(@Nullable final GuiEventListener dae) {
            this.focused = dae;
        }
