...
public class AccessibilityOptionsScreen extends Screen {
    ...
    public AccessibilityOptionsScreen(final Screen dcl, final Options cyg) {
    ...
    protected void init() {
        int integer2 = 0;
        for (final Option cyf6 : AccessibilityOptionsScreen.OPTIONS) {
        ...
        this.<Button>addButton(new Button(this.width / 2 - 100, this.height / 6 + 144, 200, 20, I18n.get("gui.done"), czi -> this.minecraft.setScreen(this.lastScreen)));
    }
