...
public class OutOfMemoryScreen extends Screen {
    ...
    @Override
    protected void init() {
        this.<Button>addButton(new Button(this.width / 2 - 155, this.height / 4 + 120 + 12, 150, 20, I18n.get("gui.toTitle"), czi -> this.minecraft.setScreen(new TitleScreen())));
        this.<Button>addButton(new Button(this.width / 2 - 155 + 160, this.height / 4 + 120 + 12, 150, 20, I18n.get("menu.quit"), czi -> this.minecraft.stop()));
    }
