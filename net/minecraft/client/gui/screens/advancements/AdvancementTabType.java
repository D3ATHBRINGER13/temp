...
enum AdvancementTabType {
    ...
    public void draw(final GuiComponent cyw, final int integer2, final int integer3, final boolean boolean4, final int integer5) {
        int integer6 = this.textureX;
        if (integer5 > 0) {
            integer6 += this.width;
        }
        if (integer5 == this.max - 1) {
            integer6 += this.width;
        }
        final int integer7 = boolean4 ? (this.textureY + this.height) : this.textureY;
        cyw.blit(integer2 + this.getX(integer5), integer3 + this.getY(integer5), integer6, integer7, this.width, this.height);
    }
    
    public void drawIcon(final int integer1, final int integer2, final int integer3, final ItemRenderer dsv, final ItemStack bcj) {
        ...
        dsv.renderAndDecorateItem(null, bcj, integer4, integer5);
    }
