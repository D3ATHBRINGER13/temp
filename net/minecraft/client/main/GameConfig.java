...
public class GameConfig {
    ...
    public GameConfig(final UserData d, final DisplayData cuc, final FolderData a, final GameData b, final ServerData c) {
        this.user = d;
        this.display = cuc;
        this.location = a;
        this.game = b;
    ...
    public static class GameData {
        ...
        public GameData(final boolean boolean1, final String string2, final String string3) {
            this.demo = boolean1;
    ...
    public static class UserData {
        ...
        public UserData(final User cyn, final PropertyMap propertyMap2, final PropertyMap propertyMap3, final Proxy proxy) {
            this.user = cyn;
    ...
    public static class ServerData {
        ...
        public ServerData(final String string, final int integer) {
