...
public class EndermanModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public EndermanModel(final float float1) {
        ...
        (this.hat = new ModelPart(this, 0, 16)).addBox(-4.0f, -8.0f, -4.0f, 8, 8, 8, float1 - 0.5f);
        this.hat.setPos(0.0f, -14.0f, 0.0f);
        (this.body = new ModelPart(this, 32, 16)).addBox(-4.0f, 0.0f, -2.0f, 8, 12, 4, float1);
        this.body.setPos(0.0f, -14.0f, 0.0f);
        (this.rightArm = new ModelPart(this, 56, 0)).addBox(-1.0f, -2.0f, -1.0f, 2, 30, 2, float1);
        ...
        (this.rightLeg = new ModelPart(this, 56, 0)).addBox(-1.0f, 0.0f, -1.0f, 2, 30, 2, float1);
