...
public class PhantomModel<T extends Entity> extends EntityModel<T> {
    ...
    public PhantomModel() {
        this.texWidth = 64;
        this.texHeight = 64;
        (this.body = new ModelPart(this, 0, 8)).addBox(-3.0f, -2.0f, -8.0f, 5, 3, 9);
        (this.tailBase = new ModelPart(this, 3, 20)).addBox(-2.0f, 0.0f, 0.0f, 3, 2, 6);
        this.tailBase.setPos(0.0f, -2.0f, 1.0f);
        this.body.addChild(this.tailBase);
        (this.tailTip = new ModelPart(this, 4, 29)).addBox(-1.0f, 0.0f, 0.0f, 1, 1, 6);
        this.tailTip.setPos(0.0f, 0.5f, 6.0f);
        this.tailBase.addChild(this.tailTip);
        (this.leftWingBase = new ModelPart(this, 23, 12)).addBox(0.0f, 0.0f, 0.0f, 6, 2, 9);
        this.leftWingBase.setPos(2.0f, -2.0f, -8.0f);
        (this.leftWingTip = new ModelPart(this, 16, 24)).addBox(0.0f, 0.0f, 0.0f, 13, 1, 9);
        ...
        this.body.xRot = -0.1f;
        (this.head = new ModelPart(this, 0, 0)).addBox(-4.0f, -2.0f, -5.0f, 7, 3, 5);
    ...
    public void setupAnim(final T aio, final float float2, final float float3, final float float4, final float float5, final float float6, final float float7) {
        final float float8 = (aio.getId() * 3 + float4) * 0.13f;
        final float float9 = 16.0f;
        this.leftWingBase.zRot = Mth.cos(float8) * 16.0f * 0.017453292f;
        this.leftWingTip.zRot = Mth.cos(float8) * 16.0f * 0.017453292f;
        this.rightWingBase.zRot = -this.leftWingBase.zRot;
        this.rightWingTip.zRot = -this.leftWingTip.zRot;
        this.tailBase.xRot = -(5.0f + Mth.cos(float8 * 2.0f) * 5.0f) * 0.017453292f;
        this.tailTip.xRot = -(5.0f + Mth.cos(float8 * 2.0f) * 5.0f) * 0.017453292f;
    }
}
