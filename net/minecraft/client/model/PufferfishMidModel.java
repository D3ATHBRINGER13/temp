...
public class PufferfishMidModel<T extends Entity> extends EntityModel<T> {
    ...
    public PufferfishMidModel() {
        ...
        (this.cube = new ModelPart(this, 12, 22)).addBox(-2.5f, -5.0f, -2.5f, 5, 5, 5);
        this.cube.setPos(0.0f, 22.0f, 0.0f);
        (this.finBlue0 = new ModelPart(this, 24, 0)).addBox(-2.0f, 0.0f, 0.0f, 2, 0, 2);
        this.finBlue0.setPos(-2.5f, 17.0f, -1.5f);
        (this.finBlue1 = new ModelPart(this, 24, 3)).addBox(0.0f, 0.0f, 0.0f, 2, 0, 2);
        this.finBlue1.setPos(2.5f, 17.0f, -1.5f);
        (this.finTop0 = new ModelPart(this, 15, 16)).addBox(-2.5f, -1.0f, 0.0f, 5, 1, 1);
        this.finTop0.setPos(0.0f, 17.0f, -2.5f);
        this.finTop0.xRot = 0.7853982f;
        (this.finTop1 = new ModelPart(this, 10, 16)).addBox(-2.5f, -1.0f, -1.0f, 5, 1, 1);
        this.finTop1.setPos(0.0f, 17.0f, 2.5f);
        this.finTop1.xRot = -0.7853982f;
        (this.finSide0 = new ModelPart(this, 8, 16)).addBox(-1.0f, -5.0f, 0.0f, 1, 5, 1);
        this.finSide0.setPos(-2.5f, 22.0f, -2.5f);
        this.finSide0.yRot = -0.7853982f;
        (this.finSide1 = new ModelPart(this, 8, 16)).addBox(-1.0f, -5.0f, 0.0f, 1, 5, 1);
        this.finSide1.setPos(-2.5f, 22.0f, 2.5f);
        this.finSide1.yRot = 0.7853982f;
        (this.finSide2 = new ModelPart(this, 4, 16)).addBox(0.0f, -5.0f, 0.0f, 1, 5, 1);
        this.finSide2.setPos(2.5f, 22.0f, 2.5f);
        this.finSide2.yRot = -0.7853982f;
        (this.finSide3 = new ModelPart(this, 0, 16)).addBox(0.0f, -5.0f, 0.0f, 1, 5, 1);
        this.finSide3.setPos(2.5f, 22.0f, -2.5f);
        this.finSide3.yRot = 0.7853982f;
        (this.finBottom0 = new ModelPart(this, 8, 22)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 1);
        this.finBottom0.setPos(0.5f, 22.0f, 2.5f);
        this.finBottom0.xRot = 0.7853982f;
        (this.finBottom1 = new ModelPart(this, 17, 21)).addBox(-2.5f, 0.0f, 0.0f, 5, 1, 1);
    ...
    public void render(final T aio, final float float2, final float float3, final float float4, final float float5, final float float6, final float float7) {
        ...
        this.finBlue0.render(float7);
        this.finBlue1.render(float7);
        this.finTop0.render(float7);
        this.finTop1.render(float7);
        this.finSide0.render(float7);
        this.finSide1.render(float7);
        this.finSide2.render(float7);
        this.finSide3.render(float7);
        this.finBottom0.render(float7);
        this.finBottom1.render(float7);
    }
