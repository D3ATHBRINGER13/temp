...
public class RavagerModel extends EntityModel<Ravager> {
    ...
    public RavagerModel() {
        ...
        final ModelPart djv4 = new ModelPart(this);
        djv4.setPos(-10.0f, -14.0f, -8.0f);
        djv4.texOffs(74, 55).addBox(0.0f, -14.0f, -2.0f, 2, 14, 4, 0.0f);
        djv4.xRot = 1.0995574f;
        this.head.addChild(djv4);
        final ModelPart djv5 = new ModelPart(this);
        djv5.mirror = true;
        djv5.setPos(8.0f, -14.0f, -8.0f);
        djv5.texOffs(74, 55).addBox(0.0f, -14.0f, -2.0f, 2, 14, 4, 0.0f);
        djv5.xRot = 1.0995574f;
        this.head.addChild(djv5);
        ...
        (this.leg0 = new ModelPart(this, 96, 0)).addBox(-4.0f, 0.0f, -4.0f, 8, 37, 8, 0.0f);
        ...
        (this.leg2 = new ModelPart(this, 64, 0)).addBox(-4.0f, 0.0f, -4.0f, 8, 37, 8, 0.0f);
    ...
    @Override
    public void render(final Ravager auz, final float float2, final float float3, final float float4, final float float5, final float float6, final float float7) {
        this.render(auz, float2, float3, float4, float5, float6, float7);
    ...
    public void render(final Ravager auz, final float float2, final float float3, final float float4, final float float5, final float float6, final float float7) {
        ...
        final float float8 = 0.4f * float3;
        this.leg0.xRot = Mth.cos(float2 * 0.6662f) * float8;
        this.leg1.xRot = Mth.cos(float2 * 0.6662f + 3.1415927f) * float8;
        this.leg2.xRot = Mth.cos(float2 * 0.6662f + 3.1415927f) * float8;
        this.leg3.xRot = Mth.cos(float2 * 0.6662f) * float8;
    }
    
    @Override
    public void prepareMobModel(final Ravager auz, final float float2, final float float3, final float float4) {
        super.prepareMobModel(auz, float2, float3, float4);
        final int integer6 = auz.getStunnedTick();
        final int integer7 = auz.getRoarTick();
        final int integer8 = 20;
        final int integer9 = auz.getAttackTick();
        final int integer10 = 10;
        if (integer9 > 0) {
            final float float5 = this.triangleWave(integer9 - float4, 10.0f);
