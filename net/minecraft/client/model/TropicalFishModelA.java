...
public class TropicalFishModelA<T extends Entity> extends EntityModel<T> {
    ...
    public TropicalFishModelA(final float float1) {
        ...
        (this.body = new ModelPart(this, 0, 0)).addBox(-1.0f, -1.5f, -3.0f, 2, 3, 6, float1);
        this.body.setPos(0.0f, 22.0f, 0.0f);
        (this.tail = new ModelPart(this, 22, -6)).addBox(0.0f, -1.5f, 0.0f, 0, 3, 6, float1);
        this.tail.setPos(0.0f, 22.0f, 3.0f);
        (this.leftFin = new ModelPart(this, 2, 16)).addBox(-2.0f, -1.0f, 0.0f, 2, 2, 0, float1);
        this.leftFin.setPos(-1.0f, 22.5f, 0.0f);
        this.leftFin.yRot = 0.7853982f;
        (this.rightFin = new ModelPart(this, 2, 12)).addBox(0.0f, -1.0f, 0.0f, 2, 2, 0, float1);
        this.rightFin.setPos(1.0f, 22.5f, 0.0f);
        this.rightFin.yRot = -0.7853982f;
        (this.topFin = new ModelPart(this, 10, -5)).addBox(0.0f, -3.0f, 0.0f, 0, 3, 6, float1);
