...
public class CritParticle extends TextureSheetParticle {
    private CritParticle(final Level bhr, final double double2, final double double3, final double double4, final double double5, final double double6, final double double7) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(final SimpleParticleType gi, final Level bhr, final double double3, final double double4, final double double5, final double double6, final double double7, final double double8) {
            final CritParticle dku16 = new CritParticle(bhr, double3, double4, double5, double6, double7, double8, null);
            dku16.pickSprite(this.sprite);
            return dku16;
        }
    }
    ...
    public static class MagicProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public MagicProvider(final SpriteSet dma) {
            this.sprite = dma;
        }
        
        public Particle createParticle(final SimpleParticleType gi, final Level bhr, final double double3, final double double4, final double double5, final double double6, final double double7, final double double8) {
            final CritParticle critParticle;
            final CritParticle dku16 = critParticle = new CritParticle(bhr, double3, double4, double5, double6, double7, double8, null);
            critParticle.rCol *= 0.3f;
            final CritParticle critParticle2 = dku16;
    ...
    public static class DamageIndicatorProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public DamageIndicatorProvider(final SpriteSet dma) {
            this.sprite = dma;
        }
        
        public Particle createParticle(final SimpleParticleType gi, final Level bhr, final double double3, final double double4, final double double5, final double double6, final double double7, final double double8) {
            final CritParticle dku16 = new CritParticle(bhr, double3, double4, double5, double6, double7 + 1.0, double8, null);
            dku16.setLifetime(20);
            dku16.pickSprite(this.sprite);
            return dku16;
        }
    }
