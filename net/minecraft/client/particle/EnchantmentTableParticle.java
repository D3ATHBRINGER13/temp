...
public class EnchantmentTableParticle extends TextureSheetParticle {
    ...
    private EnchantmentTableParticle(final Level bhr, final double double2, final double double3, final double double4, final double double5, final double double6, final double double7) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(final SimpleParticleType gi, final Level bhr, final double double3, final double double4, final double double5, final double double6, final double double7, final double double8) {
            final EnchantmentTableParticle dky16 = new EnchantmentTableParticle(bhr, double3, double4, double5, double6, double7, double8, null);
            dky16.pickSprite(this.sprite);
            return dky16;
        }
    }
    ...
    public static class NautilusProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public NautilusProvider(final SpriteSet dma) {
            this.sprite = dma;
        }
