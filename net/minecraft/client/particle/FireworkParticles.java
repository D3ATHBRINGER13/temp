...
public class FireworkParticles {
    public static class Starter extends NoRenderParticle {
        ...
        public Starter(final Level bhr, final double double2, final double double3, final double double4, final double double5, final double double6, final double double7, final ParticleEngine dlp, @Nullable final CompoundTag id) {
            ...
            this.lifetime = 8;
            if (id != null) {
                this.explosions = id.getList("Explosions", 10);
                if (this.explosions.isEmpty()) {
                    ...
                    for (int integer17 = 0; integer17 < this.explosions.size(); ++integer17) {
                        final CompoundTag id2 = this.explosions.getCompound(integer17);
                        if (id2.getBoolean("Flicker")) {
            ...
            if (this.life == 0 && this.explosions != null) {
                ...
                if (this.explosions.size() >= 3) {
                    ...
                    for (int integer4 = 0; integer4 < this.explosions.size(); ++integer4) {
                        final CompoundTag id5 = this.explosions.getCompound(integer4);
                        if (FireworkRocketItem.Shape.byId(id5.getByte("Type")) == FireworkRocketItem.Shape.LARGE_BALL) {
                            boolean3 = true;
                            break;
                        }
                    }
                ...
                SoundEvent yo4;
                if (boolean3) {
                    yo4 = (boolean2 ? SoundEvents.FIREWORK_ROCKET_LARGE_BLAST_FAR : SoundEvents.FIREWORK_ROCKET_LARGE_BLAST);
                }
                else {
                    yo4 = (boolean2 ? SoundEvents.FIREWORK_ROCKET_BLAST_FAR : SoundEvents.FIREWORK_ROCKET_BLAST);
                }
                this.level.playLocalSound(this.x, this.y, this.z, yo4, SoundSource.AMBIENT, 20.0f, 0.95f + this.random.nextFloat() * 0.1f, true);
            }
            if (this.life % 2 == 0 && this.explosions != null && this.life / 2 < this.explosions.size()) {
                final int integer5 = this.life / 2;
                final CompoundTag id6 = this.explosions.getCompound(integer5);
                final FireworkRocketItem.Shape a4 = FireworkRocketItem.Shape.byId(id6.getByte("Type"));
                final boolean boolean4 = id6.getBoolean("Trail");
                final boolean boolean5 = id6.getBoolean("Flicker");
                int[] arr7 = id6.getIntArray("Colors");
                final int[] arr8 = id6.getIntArray("FadeColors");
                if (arr7.length == 0) {
                ...
                final Particle dln13 = this.engine.createParticle(ParticleTypes.FLASH, this.x, this.y, this.z, 0.0, 0.0, 0.0);
                dln13.setColor(float10, float11, float12);
            }
            ++this.life;
            if (this.life > this.lifetime) {
                if (this.twinkleDelay) {
                    final boolean boolean2 = this.isFarAwayFromCamera();
                    final SoundEvent yo5 = boolean2 ? SoundEvents.FIREWORK_ROCKET_TWINKLE_FAR : SoundEvents.FIREWORK_ROCKET_TWINKLE;
                    this.level.playLocalSound(this.x, this.y, this.z, yo5, SoundSource.AMBIENT, 20.0f, 0.9f + this.random.nextFloat() * 0.15f, true);
                }
                this.remove();
            }
        }
        ...
        private boolean isFarAwayFromCamera() {
            ...
            return cyc2.gameRenderer.getMainCamera().getPosition().distanceToSqr(this.x, this.y, this.z) >= 256.0;
        }
        ...
        private void createParticle(final double double1, final double double2, final double double3, final double double4, final double double5, final double double6, final int[] arr7, final int[] arr8, final boolean boolean9, final boolean boolean10) {
            ...
            if (arr8.length > 0) {
                c18.setFadeColor(arr8[this.random.nextInt(arr8.length)]);
            }
        }
    ...
    static class SparkParticle extends SimpleAnimatedParticle {
        ...
        private SparkParticle(final Level bhr, final double double2, final double double3, final double double4, final double double5, final double double6, final double double7, final ParticleEngine dlp, final SpriteSet dma) {
            super(bhr, double2, double3, double4, dma, -0.004f);
            this.xd = double5;
            this.yd = double6;
            this.zd = double7;
            this.engine = dlp;
        ...
        public void render(final BufferBuilder cuw, final Camera cxq, final float float3, final float float4, final float float5, final float float6, final float float7, final float float8) {
            if (!this.flicker || this.age < this.lifetime / 3 || (this.age + this.lifetime) / 3 % 2 == 0) {
                super.render(cuw, cxq, float3, float4, float5, float6, float7, float8);
            }
        }
    ...
    public static class OverlayParticle extends TextureSheetParticle {
        private OverlayParticle(final Level bhr, final double double2, final double double3, final double double4) {
            super(bhr, double2, double3, double4);
            this.lifetime = 4;
        }
    ...
    public static class FlashProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public FlashProvider(final SpriteSet dma) {
            this.sprite = dma;
        }
        ...
        public Particle createParticle(final SimpleParticleType gi, final Level bhr, final double double3, final double double4, final double double5, final double double6, final double double7, final double double8) {
            final OverlayParticle b16 = new OverlayParticle(bhr, double3, double4, double5);
    ...
    public static class SparkProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public SparkProvider(final SpriteSet dma) {
            this.sprites = dma;
        }
        
        public Particle createParticle(final SimpleParticleType gi, final Level bhr, final double double3, final double double4, final double double5, final double double6, final double double7, final double double8) {
            final SparkParticle c16 = new SparkParticle(bhr, double3, double4, double5, double6, double7, double8, Minecraft.getInstance().particleEngine, this.sprites);
            c16.setAlpha(0.99f);
            return c16;
        }
    }
