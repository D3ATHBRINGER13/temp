...
public class HugeExplosionSeedParticle extends NoRenderParticle {
    ...
    private HugeExplosionSeedParticle(final Level bhr, final double double2, final double double3, final double double4) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        public Particle createParticle(final SimpleParticleType gi, final Level bhr, final double double3, final double double4, final double double5, final double double6, final double double7, final double double8) {
            return new HugeExplosionSeedParticle(bhr, double3, double4, double5, null);
        }
    }
}
