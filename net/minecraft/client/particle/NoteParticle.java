...
public class NoteParticle extends TextureSheetParticle {
    private NoteParticle(final Level bhr, final double double2, final double double3, final double double4, final double double5) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(final SimpleParticleType gi, final Level bhr, final double double3, final double double4, final double double5, final double double6, final double double7, final double double8) {
            final NoteParticle dlm16 = new NoteParticle(bhr, double3, double4, double5, double6, null);
            dlm16.pickSprite(this.sprite);
            return dlm16;
        }
    }
}
