...
public class SimpleAnimatedParticle extends TextureSheetParticle {
    ...
    protected SimpleAnimatedParticle(final Level bhr, final double double2, final double double3, final double double4, final SpriteSet dma, final float float6) {
