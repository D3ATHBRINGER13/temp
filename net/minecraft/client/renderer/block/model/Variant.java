...
public class Variant implements ModelState {
    ...
    public Variant(final ResourceLocation qv, final BlockModelRotation dyq, final boolean boolean3, final int integer) {
        this.modelLocation = qv;
        this.rotation = dyq;
    ...
    public boolean equals(final Object object) {
        ...
        if (object instanceof Variant) {
            final Variant doo3 = (Variant)object;
            return this.modelLocation.equals(doo3.modelLocation) && this.rotation == doo3.rotation && this.uvLock == doo3.uvLock && this.weight == doo3.weight;
        }
        return false;
    }
    ...
    public static class Deserializer implements JsonDeserializer<Variant> {
        public Variant deserialize(final JsonElement jsonElement, final Type type, final JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
            ...
            final ResourceLocation qv6 = this.getModel(jsonObject5);
            final BlockModelRotation dyq7 = this.getBlockRotation(jsonObject5);
            final boolean boolean8 = this.getUvLock(jsonObject5);
            final int integer9 = this.getWeight(jsonObject5);
            return new Variant(qv6, dyq7, boolean8, integer9);
        }
        ...
        protected BlockModelRotation getBlockRotation(final JsonObject jsonObject) {
            ...
            final BlockModelRotation dyq5 = BlockModelRotation.by(integer3, integer4);
            if (dyq5 == null) {
