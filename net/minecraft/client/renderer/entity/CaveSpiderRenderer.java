...
public class CaveSpiderRenderer extends SpiderRenderer<CaveSpider> {
    ...
    public CaveSpiderRenderer(final EntityRenderDispatcher dsa) {
        super(dsa);
        this.shadowRadius *= 0.7f;
    }
    
    protected void scale(final CaveSpider aud, final float float2) {
        GlStateManager.scalef(0.7f, 0.7f, 0.7f);
    }
    
    @Override
    protected ResourceLocation getTextureLocation(final CaveSpider aud) {
