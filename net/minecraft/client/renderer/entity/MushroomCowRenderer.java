...
public class MushroomCowRenderer extends MobRenderer<MushroomCow, CowModel<MushroomCow>> {
    ...
    public MushroomCowRenderer(final EntityRenderDispatcher dsa) {
        super(dsa, new CowModel(), 0.7f);
        this.addLayer((RenderLayer<MushroomCow, CowModel<MushroomCow>>)new MushroomCowMushroomLayer(this));
    }
    
    protected ResourceLocation getTextureLocation(final MushroomCow arj) {
        return (ResourceLocation)MushroomCowRenderer.TEXTURES.get(arj.getMushroomType());
    }
