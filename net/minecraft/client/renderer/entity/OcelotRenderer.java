...
public class OcelotRenderer extends MobRenderer<Ocelot, OcelotModel<Ocelot>> {
    ...
    public OcelotRenderer(final EntityRenderDispatcher dsa) {
        super(dsa, new OcelotModel(0.0f), 0.4f);
    }
    
    protected ResourceLocation getTextureLocation(final Ocelot ark) {
