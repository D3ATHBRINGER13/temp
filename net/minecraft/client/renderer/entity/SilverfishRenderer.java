...
public class SilverfishRenderer extends MobRenderer<Silverfish, SilverfishModel<Silverfish>> {
    ...
    public SilverfishRenderer(final EntityRenderDispatcher dsa) {
        super(dsa, new SilverfishModel(), 0.3f);
    }
    
    @Override
    protected float getFlipDegrees(final Silverfish avc) {
        return 180.0f;
    }
    
    protected ResourceLocation getTextureLocation(final Silverfish avc) {
