...
public class TippableArrowRenderer extends ArrowRenderer<Arrow> {
    ...
    public TippableArrowRenderer(final EntityRenderDispatcher dsa) {
        super(dsa);
    }
    
    @Override
    protected ResourceLocation getTextureLocation(final Arrow awm) {
        return (awm.getColor() > 0) ? TippableArrowRenderer.TIPPED_ARROW_LOCATION : TippableArrowRenderer.NORMAL_ARROW_LOCATION;
    }
