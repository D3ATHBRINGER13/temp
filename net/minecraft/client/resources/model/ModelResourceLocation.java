...
public class ModelResourceLocation extends ResourceLocation {
    ...
    public ModelResourceLocation(final ResourceLocation qv, final String string) {
        this(qv.toString(), string);
    }
    ...
    public boolean equals(final Object object) {
        ...
        if (object instanceof ModelResourceLocation && super.equals(object)) {
            final ModelResourceLocation dyu3 = (ModelResourceLocation)object;
            return this.variant.equals(dyu3.variant);
        }
        return false;
    }
