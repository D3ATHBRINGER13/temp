...
public class WeightedBakedModel implements BakedModel {
    ...
    public List<BakedQuad> getQuads(@Nullable final BlockState bvt, @Nullable final Direction fb, final Random random) {
        return WeighedRandom.<WeightedModel>getWeightedItem(this.list, Math.abs((int)random.nextLong()) % this.totalWeight).model.getQuads(bvt, fb, random);
    }
    ...
    public static class Builder {
        ...
        public Builder add(@Nullable final BakedModel dyp, final int integer) {
            if (dyp != null) {
                this.list.add(new WeightedModel(dyp, integer));
            }
            return this;
        }
    ...
    static class WeightedModel extends WeighedRandom.WeighedRandomItem {
        ...
        public WeightedModel(final BakedModel dyp, final int integer) {
            super(integer);
            this.model = dyp;
        }
    }
