...
public class MovementTutorialStepInstance implements TutorialStepInstance {
    ...
    public MovementTutorialStepInstance(final Tutorial eaz) {
    ...
    public void onInput(final Input dmn) {
        if (dmn.up || dmn.down || dmn.left || dmn.right || dmn.jumping) {
            this.moved = true;
        }
    }
    ...
    static {
        ...
        LOOK_TITLE = new TranslatableComponent("tutorial.look.title", new Object[0]);
        LOOK_DESCRIPTION = new TranslatableComponent("tutorial.look.description", new Object[0]);
    }
}
