...
public enum TutorialSteps {
    ...
    public TutorialStepInstance create(final Tutorial eaz) {
        return (TutorialStepInstance)this.constructor.apply(eaz);
    }
    ...
    public static TutorialSteps getByName(final String string) {
        for (final TutorialSteps ebb5 : values()) {
            if (ebb5.name.equals(string)) {
                return ebb5;
            }
        }
