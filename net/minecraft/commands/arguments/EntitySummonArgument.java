...
public class EntitySummonArgument implements ArgumentType<ResourceLocation> {
    ...
    private static ResourceLocation verifyCanSummon(final ResourceLocation qv) throws CommandSyntaxException {
        Registry.ENTITY_TYPE.getOptional(qv).filter(EntityType::canSummon).orElseThrow(() -> EntitySummonArgument.ERROR_UNKNOWN_ENTITY.create(qv));
        return qv;
    }
