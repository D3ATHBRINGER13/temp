...
public class ObjectiveCriteriaArgument implements ArgumentType<ObjectiveCriteria> {
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(final CommandContext<S> commandContext, final SuggestionsBuilder suggestionsBuilder) {
        ...
        for (final StatType<?> yx6 : Registry.STAT_TYPE) {
            for (final Object object8 : yx6.getRegistry()) {
                final String string9 = this.getName(yx6, object8);
                list4.add(string9);
            }
        }
    ...
    public <T> String getName(final StatType<T> yx, final Object object) {
        return Stat.buildName((StatType<Object>)yx, object);
    }
