...
public class RotationArgument implements ArgumentType<Coordinates> {
    ...
    public Coordinates parse(final StringReader stringReader) throws CommandSyntaxException {
        ...
        final WorldCoordinate ds4 = WorldCoordinate.parseDouble(stringReader, false);
        ...
        return new WorldCoordinates(ds5, ds4, new WorldCoordinate(true, 0.0));
    }
    ...
    static {
        ...
        ERROR_NOT_COMPLETE = new SimpleCommandExceptionType((Message)new TranslatableComponent("argument.rotation.incomplete", new Object[0]));
    }
}
