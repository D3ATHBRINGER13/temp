...
public class Vec3Argument implements ArgumentType<Coordinates> {
    ...
    static {
        ...
        ERROR_NOT_COMPLETE = new SimpleCommandExceptionType((Message)new TranslatableComponent("argument.pos3d.incomplete", new Object[0]));
        ERROR_MIXED_TYPE = new SimpleCommandExceptionType((Message)new TranslatableComponent("argument.pos.mixed", new Object[0]));
    }
}
