...
public class ItemArgument implements ArgumentType<ItemInput> {
    ...
    public ItemInput parse(final StringReader stringReader) throws CommandSyntaxException {
        final ItemParser dy3 = new ItemParser(stringReader, false).parse();
        return new ItemInput(dy3.getItem(), dy3.getNbt());
    }
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(final CommandContext<S> commandContext, final SuggestionsBuilder suggestionsBuilder) {
        ...
        final ItemParser dy5 = new ItemParser(stringReader4, false);
        try {
            dy5.parse();
        }
