...
public class ArgumentTypes {
    ...
    public static <T extends ArgumentType<?>> void register(final String string, final Class<T> class2, final ArgumentSerializer<T> ej) {
        ...
        if (ArgumentTypes.BY_NAME.containsKey(qv4)) {
            throw new IllegalArgumentException(new StringBuilder().append("'").append(qv4).append("' is already a registered serializer!").toString());
        }
        final Entry<T> a5 = new Entry<T>((Class)class2, (ArgumentSerializer)ej, qv4);
        ArgumentTypes.BY_CLASS.put(class2, a5);
        ArgumentTypes.BY_NAME.put(qv4, a5);
    }
    ...
    public static void bootStrap() {
        ...
        ArgumentTypes.<ArgumentType>register("int_range", (java.lang.Class<ArgumentType>)RangeArgument.Ints.class, (ArgumentSerializer<ArgumentType>)new RangeArgument.Ints.Serializer());
        ArgumentTypes.<ArgumentType>register("float_range", (java.lang.Class<ArgumentType>)RangeArgument.Floats.class, (ArgumentSerializer<ArgumentType>)new RangeArgument.Floats.Serializer());
        ...
        ArgumentTypes.<ArgumentType>register("dimension", (java.lang.Class<ArgumentType>)DimensionTypeArgument.class, (ArgumentSerializer<ArgumentType>)new EmptyArgumentSerializer<ArgumentType>((java.util.function.Supplier<ArgumentType>)DimensionTypeArgument::dimension));
    ...
    @Nullable
    private static Entry<?> get(final ResourceLocation qv) {
        return ArgumentTypes.BY_NAME.get(qv);
    }
    ...
    public static <T extends ArgumentType<?>> void serialize(final FriendlyByteBuf je, final T argumentType) {
        ...
        if (a3 == null) {
            ...
            je.writeResourceLocation(new ResourceLocation(""));
            return;
        }
        je.writeResourceLocation(a3.name);
        a3.serializer.serializeToNetwork(argumentType, je);
    }
    
    @Nullable
    public static ArgumentType<?> deserialize(final FriendlyByteBuf je) {
        final ResourceLocation qv2 = je.readResourceLocation();
        final Entry<?> a3 = get(qv2);
        if (a3 == null) {
            ArgumentTypes.LOGGER.error("Could not deserialize {}", qv2);
            return null;
        }
        return a3.serializer.deserializeFromNetwork(je);
    }
    ...
    static class Entry<T extends ArgumentType<?>> {
        ...
        private Entry(final Class<T> class1, final ArgumentSerializer<T> ej, final ResourceLocation qv) {
            this.clazz = class1;
            this.serializer = ej;
            this.name = qv;
        }
