...
public interface DataProvider {
    ...
    void run(final HashCache gm) throws IOException;
    
    String getName();
    
    default void save(final Gson gson, final HashCache gm, final JsonElement jsonElement, final Path path) throws IOException {
        ...
        if (!Objects.equals(gm.getHash(path), string6) || !Files.exists(path, new LinkOption[0])) {
