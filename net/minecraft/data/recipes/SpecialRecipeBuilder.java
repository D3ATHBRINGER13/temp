...
public class SpecialRecipeBuilder {
    ...
    public SpecialRecipeBuilder(final SimpleRecipeSerializer<?> bfb) {
        this.serializer = bfb;
    }
    
    public static SpecialRecipeBuilder special(final SimpleRecipeSerializer<?> bfb) {
        return new SpecialRecipeBuilder(bfb);
    }
