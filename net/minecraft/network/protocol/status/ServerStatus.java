...
public class ServerStatus {
    ...
    public void setDescription(final Component jo) {
        this.description = jo;
    }
    ...
    public static class Serializer implements JsonDeserializer<ServerStatus>, JsonSerializer<ServerStatus> {
        public ServerStatus deserialize(final JsonElement jsonElement, final Type type, final JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
            ...
            final ServerStatus qf6 = new ServerStatus();
            if (jsonObject5.has("description")) {
                qf6.setDescription((Component)jsonDeserializationContext.deserialize(jsonObject5.get("description"), (Type)Component.class));
            }
            if (jsonObject5.has("players")) {
                qf6.setPlayers((Players)jsonDeserializationContext.deserialize(jsonObject5.get("players"), (Type)Players.class));
            }
            if (jsonObject5.has("version")) {
                qf6.setVersion((Version)jsonDeserializationContext.deserialize(jsonObject5.get("version"), (Type)Version.class));
            }
            if (jsonObject5.has("favicon")) {
                qf6.setFavicon(GsonHelper.getAsString(jsonObject5, "favicon"));
            }
            return qf6;
        }
        
        public JsonElement serialize(final ServerStatus qf, final Type type, final JsonSerializationContext jsonSerializationContext) {
            final JsonObject jsonObject5 = new JsonObject();
            if (qf.getDescription() != null) {
                jsonObject5.add("description", jsonSerializationContext.serialize(qf.getDescription()));
            }
            if (qf.getPlayers() != null) {
                jsonObject5.add("players", jsonSerializationContext.serialize(qf.getPlayers()));
            }
            if (qf.getVersion() != null) {
                jsonObject5.add("version", jsonSerializationContext.serialize(qf.getVersion()));
            }
            if (qf.getFavicon() != null) {
                jsonObject5.addProperty("favicon", qf.getFavicon());
            }
            return (JsonElement)jsonObject5;
        }
    }
