...
public class DisconnectedRealmsScreen extends RealmsScreen {
    ...
    public DisconnectedRealmsScreen(final RealmsScreen realmsScreen, final String string, final Component jo) {
    ...
    public void render(final int integer1, final int integer2, final float float3) {
        ...
        if (this.lines != null) {
            for (final String string7 : this.lines) {
                this.drawCenteredString(string7, this.width() / 2, integer3, 16777215);
