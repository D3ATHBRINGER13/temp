...
public interface PlaceRecipe<T> {
    default void placeRecipe(final int integer1, final int integer2, final int integer3, final Recipe<?> ber, final Iterator<T> iterator, final int integer6) {
        int integer7 = integer1;
        int integer8 = integer2;
        if (ber instanceof ShapedRecipe) {
            final ShapedRecipe bew10 = (ShapedRecipe)ber;
            integer7 = bew10.getWidth();
            integer8 = bew10.getHeight();
        }
        int integer9 = 0;
