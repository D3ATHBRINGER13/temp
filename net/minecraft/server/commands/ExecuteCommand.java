...
public class ExecuteCommand {
    ...
    public static void register(final CommandDispatcher<CommandSourceStack> commandDispatcher) {
        final LiteralCommandNode<CommandSourceStack> literalCommandNode2 = (LiteralCommandNode<CommandSourceStack>)commandDispatcher.register((LiteralArgumentBuilder)Commands.literal("execute").requires(cd -> cd.hasPermission(2)));
        commandDispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("execute").requires(cd -> cd.hasPermission(2))).then(Commands.literal("run").redirect((CommandNode)commandDispatcher.getRoot()))).then((ArgumentBuilder)addConditionals((CommandNode<CommandSourceStack>)literalCommandNode2, Commands.literal("if"), true))).then((ArgumentBuilder)addConditionals((CommandNode<CommandSourceStack>)literalCommandNode2, Commands.literal("unless"), false))).then(Commands.literal("as").then(Commands.argument("targets", (com.mojang.brigadier.arguments.ArgumentType<Object>)EntityArgument.entities()).fork((CommandNode)literalCommandNode2, commandContext -> {
            final List<CommandSourceStack> list2 = (List<CommandSourceStack>)Lists.newArrayList();
            for (final Entity aio4 : EntityArgument.getOptionalEntities((CommandContext<CommandSourceStack>)commandContext, "targets")) {
                list2.add(((CommandSourceStack)commandContext.getSource()).withEntity(aio4));
            }
            ...
            final List<CommandSourceStack> list2 = (List<CommandSourceStack>)Lists.newArrayList();
            for (final Entity aio4 : EntityArgument.getOptionalEntities((CommandContext<CommandSourceStack>)commandContext, "targets")) {
                list2.add(((CommandSourceStack)commandContext.getSource()).withLevel((ServerLevel)aio4.level).withPosition(aio4.getCommandSenderWorldPosition()).withRotation(aio4.getRotationVector()));
            }
            return (Collection)list2;
        })))).then(((LiteralArgumentBuilder)Commands.literal("store").then((ArgumentBuilder)wrapStores(literalCommandNode2, Commands.literal("result"), true))).then((ArgumentBuilder)wrapStores(literalCommandNode2, Commands.literal("success"), false)))).then(((LiteralArgumentBuilder)Commands.literal("positioned").then(Commands.argument("pos", (com.mojang.brigadier.arguments.ArgumentType<Object>)Vec3Argument.vec3()).redirect((CommandNode)literalCommandNode2, commandContext -> ((CommandSourceStack)commandContext.getSource()).withPosition(Vec3Argument.getVec3((CommandContext<CommandSourceStack>)commandContext, "pos"))))).then(Commands.literal("as").then(Commands.argument("targets", (com.mojang.brigadier.arguments.ArgumentType<Object>)EntityArgument.entities()).fork((CommandNode)literalCommandNode2, commandContext -> {
            final List<CommandSourceStack> list2 = (List<CommandSourceStack>)Lists.newArrayList();
            for (final Entity aio4 : EntityArgument.getOptionalEntities((CommandContext<CommandSourceStack>)commandContext, "targets")) {
                list2.add(((CommandSourceStack)commandContext.getSource()).withPosition(aio4.getCommandSenderWorldPosition()));
            }
            return (Collection)list2;
            ...
            final List<CommandSourceStack> list2 = (List<CommandSourceStack>)Lists.newArrayList();
            for (final Entity aio4 : EntityArgument.getOptionalEntities((CommandContext<CommandSourceStack>)commandContext, "targets")) {
                list2.add(((CommandSourceStack)commandContext.getSource()).withRotation(aio4.getRotationVector()));
            }
            return (Collection)list2;
    ...
    private static ArgumentBuilder<CommandSourceStack, ?> wrapStores(final LiteralCommandNode<CommandSourceStack> literalCommandNode, final LiteralArgumentBuilder<CommandSourceStack> literalArgumentBuilder, final boolean boolean3) {
        ...
        for (final DataCommands.DataProvider c5 : DataCommands.TARGET_PROVIDERS) {
            c5.wrap(literalArgumentBuilder, (Function<ArgumentBuilder<CommandSourceStack, ?>, ArgumentBuilder<CommandSourceStack, ?>>)(argumentBuilder -> argumentBuilder.then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("path", (com.mojang.brigadier.arguments.ArgumentType<Object>)NbtPathArgument.nbtPath()).then(Commands.literal("int").then(Commands.argument("scale", (com.mojang.brigadier.arguments.ArgumentType<Object>)DoubleArgumentType.doubleArg()).redirect((CommandNode)literalCommandNode, commandContext -> storeData((CommandSourceStack)commandContext.getSource(), c5.access((CommandContext<CommandSourceStack>)commandContext), NbtPathArgument.getPath((CommandContext<CommandSourceStack>)commandContext, "path"), (IntFunction<Tag>)(integer -> new IntTag((int)(integer * DoubleArgumentType.getDouble(commandContext, "scale")))), boolean3))))).then(Commands.literal("float").then(Commands.argument("scale", (com.mojang.brigadier.arguments.ArgumentType<Object>)DoubleArgumentType.doubleArg()).redirect((CommandNode)literalCommandNode, commandContext -> storeData((CommandSourceStack)commandContext.getSource(), c5.access((CommandContext<CommandSourceStack>)commandContext), NbtPathArgument.getPath((CommandContext<CommandSourceStack>)commandContext, "path"), (IntFunction<Tag>)(integer -> new FloatTag((float)(integer * DoubleArgumentType.getDouble(commandContext, "scale")))), boolean3))))).then(Commands.literal("short").then(Commands.argument("scale", (com.mojang.brigadier.arguments.ArgumentType<Object>)DoubleArgumentType.doubleArg()).redirect((CommandNode)literalCommandNode, commandContext -> storeData((CommandSourceStack)commandContext.getSource(), c5.access((CommandContext<CommandSourceStack>)commandContext), NbtPathArgument.getPath((CommandContext<CommandSourceStack>)commandContext, "path"), (IntFunction<Tag>)(integer -> new ShortTag((short)(integer * DoubleArgumentType.getDouble(commandContext, "scale")))), boolean3))))).then(Commands.literal("long").then(Commands.argument("scale", (com.mojang.brigadier.arguments.ArgumentType<Object>)DoubleArgumentType.doubleArg()).redirect((CommandNode)literalCommandNode, commandContext -> storeData((CommandSourceStack)commandContext.getSource(), c5.access((CommandContext<CommandSourceStack>)commandContext), NbtPathArgument.getPath((CommandContext<CommandSourceStack>)commandContext, "path"), (IntFunction<Tag>)(integer -> new LongTag((long)(integer * DoubleArgumentType.getDouble(commandContext, "scale")))), boolean3))))).then(Commands.literal("double").then(Commands.argument("scale", (com.mojang.brigadier.arguments.ArgumentType<Object>)DoubleArgumentType.doubleArg()).redirect((CommandNode)literalCommandNode, commandContext -> storeData((CommandSourceStack)commandContext.getSource(), c5.access((CommandContext<CommandSourceStack>)commandContext), NbtPathArgument.getPath((CommandContext<CommandSourceStack>)commandContext, "path"), (IntFunction<Tag>)(integer -> new DoubleTag(integer * DoubleArgumentType.getDouble(commandContext, "scale"))), boolean3))))).then(Commands.literal("byte").then(Commands.argument("scale", (com.mojang.brigadier.arguments.ArgumentType<Object>)DoubleArgumentType.doubleArg()).redirect((CommandNode)literalCommandNode, commandContext -> storeData((CommandSourceStack)commandContext.getSource(), c5.access((CommandContext<CommandSourceStack>)commandContext), NbtPathArgument.getPath((CommandContext<CommandSourceStack>)commandContext, "path"), (IntFunction<Tag>)(integer -> new ByteTag((byte)(integer * DoubleArgumentType.getDouble(commandContext, "scale")))), boolean3)))))));
        }
        return literalArgumentBuilder;
    }
    
    private static CommandSourceStack storeValue(final CommandSourceStack cd, final Collection<String> collection, final Objective ctf, final boolean boolean4) {
        final Scoreboard cti5 = cd.getServer().getScoreboard();
        return cd.withCallback((ResultConsumer<CommandSourceStack>)((commandContext, boolean6, integer) -> {
            for (final String string9 : collection) {
                final Score cth10 = cti5.getOrCreatePlayerScore(string9, ctf);
                final int integer2 = boolean4 ? integer : (boolean6 ? 1 : 0);
                cth10.setScore(integer2);
            }
        }), ExecuteCommand.CALLBACK_CHAINER);
    }
    
    private static CommandSourceStack storeValue(final CommandSourceStack cd, final CustomBossEvent rl, final boolean boolean3, final boolean boolean4) {
        return cd.withCallback((ResultConsumer<CommandSourceStack>)((commandContext, boolean5, integer) -> {
            final int integer2 = boolean4 ? integer : (boolean5 ? 1 : 0);
            if (boolean3) {
                rl.setValue(integer2);
            }
            else {
                rl.setMax(integer2);
            }
    ...
    private static CommandSourceStack storeData(final CommandSourceStack cd, final DataAccessor ue, final NbtPathArgument.NbtPath h, final IntFunction<Tag> intFunction, final boolean boolean5) {
        return cd.withCallback((ResultConsumer<CommandSourceStack>)((commandContext, boolean6, integer) -> {
            try {
                final CompoundTag id8 = ue.getData();
                final int integer2 = boolean5 ? integer : (boolean6 ? 1 : 0);
                h.set(id8, (Supplier<Tag>)(() -> (Tag)intFunction.apply(integer2)));
                ue.setData(id8);
            }
    ...
    private static int checkMatchingData(final DataAccessor ue, final NbtPathArgument.NbtPath h) throws CommandSyntaxException {
        return h.countMatching(ue.getData());
    }
    ...
    private static boolean checkScore(final CommandContext<CommandSourceStack> commandContext, final BiPredicate<Integer, Integer> biPredicate) throws CommandSyntaxException {
        ...
        final Objective ctf4 = ObjectiveArgument.getObjective(commandContext, "targetObjective");
        final String string4 = ScoreHolderArgument.getName(commandContext, "source");
        final Objective ctf5 = ObjectiveArgument.getObjective(commandContext, "sourceObjective");
        final Scoreboard cti7 = ((CommandSourceStack)commandContext.getSource()).getServer().getScoreboard();
        if (!cti7.hasPlayerScore(string3, ctf4) || !cti7.hasPlayerScore(string4, ctf5)) {
            return false;
        }
        final Score cth8 = cti7.getOrCreatePlayerScore(string3, ctf4);
        final Score cth9 = cti7.getOrCreatePlayerScore(string4, ctf5);
        return biPredicate.test(cth8.getScore(), cth9.getScore());
    }
    ...
    private static boolean checkScore(final CommandContext<CommandSourceStack> commandContext, final MinMaxBounds.Ints d) throws CommandSyntaxException {
        final String string3 = ScoreHolderArgument.getName(commandContext, "target");
        final Objective ctf4 = ObjectiveArgument.getObjective(commandContext, "targetObjective");
        final Scoreboard cti5 = ((CommandSourceStack)commandContext.getSource()).getServer().getScoreboard();
        return cti5.hasPlayerScore(string3, ctf4) && d.matches(cti5.getOrCreatePlayerScore(string3, ctf4).getScore());
    }
    ...
    private static OptionalInt checkRegions(final ServerLevel vk, final BlockPos ew2, final BlockPos ew3, final BlockPos ew4, final boolean boolean5) throws CommandSyntaxException {
        final BoundingBox cic6 = new BoundingBox(ew2, ew3);
        final BoundingBox cic7 = new BoundingBox(ew4, ew4.offset(cic6.getLength()));
        final BlockPos ew5 = new BlockPos(cic7.x0 - cic6.x0, cic7.y0 - cic6.y0, cic7.z0 - cic6.z0);
        final int integer9 = cic6.getXSpan() * cic6.getYSpan() * cic6.getZSpan();
        if (integer9 > 32768) {
            throw ExecuteCommand.ERROR_AREA_TOO_LARGE.create(32768, integer9);
        }
        int integer10 = 0;
        for (int integer11 = cic6.z0; integer11 <= cic6.z1; ++integer11) {
            for (int integer12 = cic6.y0; integer12 <= cic6.y1; ++integer12) {
                for (int integer13 = cic6.x0; integer13 <= cic6.x1; ++integer13) {
                    final BlockPos ew6 = new BlockPos(integer13, integer12, integer11);
                    final BlockPos ew7 = ew6.offset(ew5);
                    final BlockState bvt16 = vk.getBlockState(ew6);
                    if (!boolean5 || bvt16.getBlock() != Blocks.AIR) {
                        if (bvt16 != vk.getBlockState(ew7)) {
                            return OptionalInt.empty();
                        }
                        final BlockEntity btw17 = vk.getBlockEntity(ew6);
                        final BlockEntity btw18 = vk.getBlockEntity(ew7);
                        if (btw17 != null) {
                            if (btw18 == null) {
                                return OptionalInt.empty();
                            }
                            final CompoundTag id19 = btw17.save(new CompoundTag());
                            id19.remove("x");
                            id19.remove("y");
                            id19.remove("z");
                            final CompoundTag id20 = btw18.save(new CompoundTag());
                            id20.remove("x");
                            id20.remove("y");
                            id20.remove("z");
                            if (!id19.equals(id20)) {
