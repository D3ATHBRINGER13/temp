...
public class ParticleCommand {
    ...
    private static int sendParticles(final CommandSourceStack cd, final ParticleOptions gf, final Vec3 csi3, final Vec3 csi4, final float float5, final int integer, final boolean boolean7, final Collection<ServerPlayer> collection) throws CommandSyntaxException {
        ...
        cd.sendSuccess(new TranslatableComponent("commands.particle.success", new Object[] { Registry.PARTICLE_TYPE.getKey(gf.getType()).toString() }), true);
        return integer2;
    }
    
    static {
        ERROR_FAILED = new SimpleCommandExceptionType((Message)new TranslatableComponent("commands.particle.failed", new Object[0]));
    }
}
