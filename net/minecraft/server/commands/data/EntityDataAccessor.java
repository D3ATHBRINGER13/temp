...
public class EntityDataAccessor implements DataAccessor {
    ...
    public EntityDataAccessor(final Entity aio) {
        this.entity = aio;
    }
    
    public void setData(final CompoundTag id) throws CommandSyntaxException {
    ...
    public Component getPrintSuccess(final Tag iu) {
        return new TranslatableComponent("commands.data.entity.query", new Object[] { this.entity.getDisplayName(), iu.getPrettyDisplay() });
    }
    ...
    static {
        ERROR_NO_PLAYERS = new SimpleCommandExceptionType((Message)new TranslatableComponent("commands.data.entity.invalid", new Object[0]));
