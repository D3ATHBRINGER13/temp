...
public class ServerWatchdog implements Runnable {
    ...
    public ServerWatchdog(final DedicatedServer uk) {
        this.server = uk;
        this.maxTickTime = uk.getMaxTickLength();
    }
    ...
    public void run() {
        while (this.server.isRunning()) {
            ...
            if (long4 > this.maxTickTime) {
                ...
                final CrashReport d12 = new CrashReport("Watching Server", (Throwable)error11);
                this.server.fillReport(d12);
                final CrashReportCategory e13 = d12.addCategory("Thread Dump");
                e13.setDetail("Threads", stringBuilder10);
