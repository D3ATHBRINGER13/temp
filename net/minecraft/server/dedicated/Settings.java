...
public abstract class Settings<T extends Settings<T>> {
    ...
    protected abstract T reload(final Properties properties);
    ...
    public class MutableValue<V> implements Supplier<V> {
        ...
        public T update(final V object) {
            final Properties properties3 = Settings.this.cloneProperties();
            properties3.put(this.key, this.serializer.apply(object));
            return Settings.this.reload(properties3);
        }
    }
}
