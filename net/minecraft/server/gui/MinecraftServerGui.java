...
public class MinecraftServerGui extends JComponent {
    ...
    public static MinecraftServerGui showFrameFor(final DedicatedServer uk) {
        ...
        uq3.addFinalizer(jFrame2::dispose);
        uq3.start();
        return uq3;
    }
    
    private MinecraftServerGui(final DedicatedServer uk) {
    ...
    private JComponent buildInfoPanel() {
        ...
        final StatsComponent us3 = new StatsComponent(this.server);
        this.finalizers.add(us3::close);
        jPanel2.add((Component)us3, "North");
