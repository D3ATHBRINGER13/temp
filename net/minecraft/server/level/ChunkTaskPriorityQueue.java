...
public class ChunkTaskPriorityQueue<T> {
    ...
    protected void resortChunkTasks(final int integer1, final ChunkPos bhd, final int integer3) {
        ...
        final List<Optional<T>> list6 = (List<Optional<T>>)long2ObjectLinkedOpenHashMap5.remove(bhd.toLong());
        ...
        if (list6 != null && !list6.isEmpty()) {
            ((List)((Long2ObjectLinkedOpenHashMap)this.taskQueue.get(integer3)).computeIfAbsent(bhd.toLong(), long1 -> Lists.newArrayList())).addAll((Collection)list6);
