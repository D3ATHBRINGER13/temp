...
public class RconClient extends GenericThread {
    ...
    RconClient(final ServerInterface ri, final String string, final Socket socket) {
        super(ri, "RCON Client");
        ...
        this.info(new StringBuilder().append("Rcon connection from: ").append(socket.getInetAddress()).toString());
    }
    ...
    private void send(final int integer1, final int integer2, final String string) throws IOException {
        ...
        final byte[] arr7 = string.getBytes("UTF-8");
    ...
    private void closeSocket() {
        ...
        try {
            ...
            this.warn("IO: " + iOException2.getMessage());
        }
        this.client = null;
    }
