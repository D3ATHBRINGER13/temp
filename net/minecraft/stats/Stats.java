...
public class Stats {
    ...
    private static ResourceLocation makeCustomStat(final String string, final StatFormatter yw) {
        final ResourceLocation qv3 = new ResourceLocation(string);
        Registry.<ResourceLocation>register(Registry.CUSTOM_STAT, string, qv3);
        Stats.CUSTOM.get(qv3, yw);
        return qv3;
    }
    
    private static <T> StatType<T> makeRegistryStatType(final String string, final Registry<T> fn) {
        return Registry.<StatType<T>>register(Registry.STAT_TYPE, string, new StatType<T>(fn));
    }
    
    static {
        BLOCK_MINED = Stats.<Block>makeRegistryStatType("mined", (Registry<Block>)Registry.BLOCK);
        ITEM_CRAFTED = Stats.<Item>makeRegistryStatType("crafted", (Registry<Item>)Registry.ITEM);
        ITEM_USED = Stats.<Item>makeRegistryStatType("used", (Registry<Item>)Registry.ITEM);
        ITEM_BROKEN = Stats.<Item>makeRegistryStatType("broken", (Registry<Item>)Registry.ITEM);
        ITEM_PICKED_UP = Stats.<Item>makeRegistryStatType("picked_up", (Registry<Item>)Registry.ITEM);
        ITEM_DROPPED = Stats.<Item>makeRegistryStatType("dropped", (Registry<Item>)Registry.ITEM);
        ENTITY_KILLED = Stats.<EntityType<?>>makeRegistryStatType("killed", (Registry<EntityType<?>>)Registry.ENTITY_TYPE);
        ENTITY_KILLED_BY = Stats.<EntityType<?>>makeRegistryStatType("killed_by", (Registry<EntityType<?>>)Registry.ENTITY_TYPE);
        CUSTOM = Stats.<ResourceLocation>makeRegistryStatType("custom", Registry.CUSTOM_STAT);
