...
public class HttpUtil {
    ...
    public static CompletableFuture<?> downloadTo(final File file, final String string, final Map<String, String> map, final int integer, @Nullable final ProgressListener zz, final Proxy proxy) {
        return CompletableFuture.supplyAsync(() -> {
            HttpURLConnection httpURLConnection7 = null;
            InputStream inputStream8 = null;
            OutputStream outputStream9 = null;
            if (zz != null) {
                zz.progressStart(new TranslatableComponent("resourcepack.downloading", new Object[0]));
                zz.progressStage(new TranslatableComponent("resourcepack.requesting", new Object[0]));
            }
            try {
                ...
                for (final Map.Entry<String, String> entry15 : map.entrySet()) {
                    ...
                    if (zz != null) {
                        zz.progressStagePercentage((int)(++float12 / float13 * 100.0f));
                    }
                }
                ...
                if (zz != null) {
                    zz.progressStage(new TranslatableComponent("resourcepack.progress", new Object[] { String.format(Locale.ROOT, "%.2f", new Object[] { float13 / 1000.0f / 1000.0f }) }));
                }
                if (file.exists()) {
