...
public class Mth {
    ...
    public static int colorMultiply(final int integer1, final int integer2) {
        final int integer3 = (integer1 & 0xFF0000) >> 16;
        final int integer4 = (integer2 & 0xFF0000) >> 16;
        final int integer5 = (integer1 & 0xFF00) >> 8;
        final int integer6 = (integer2 & 0xFF00) >> 8;
        final int integer7 = (integer1 & 0xFF) >> 0;
        final int integer8 = (integer2 & 0xFF) >> 0;
    ...
    public static long getSeed(final Vec3i fs) {
        return getSeed(fs.getX(), fs.getY(), fs.getZ());
    }
