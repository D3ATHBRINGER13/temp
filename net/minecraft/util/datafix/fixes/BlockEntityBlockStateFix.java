...
public class BlockEntityBlockStateFix extends NamedEntityFix {
    ...
    protected Typed<?> fix(final Typed<?> typed) {
        ...
        return typed2.set(DSL.remainderFinder(), dynamic6).set((OpticFinder)opticFinder5, (Typed)((Optional)type4.readTyped((Dynamic)dynamic7).getSecond()).orElseThrow(() -> new IllegalStateException("Could not parse newly created block state tag.")));
    }
}
