    ...
    protected Typed<?> fix(final Typed<?> typed) {
        ...
        if (integer7 > 0) {
            ...
            if (string8 != null) {
                ...
                return typed.set((OpticFinder)opticFinder5, (Typed)((Optional)type4.readTyped((Dynamic)dynamic7).getSecond()).orElseThrow(() -> new IllegalStateException("Could not create record item stack."))).set(DSL.remainderFinder(), dynamic6);
            }
        }
        return typed;
    }
