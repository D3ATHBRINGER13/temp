...
public class ChunkStructuresTemplateRenameFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", (Type)type2, typed -> typed.updateTyped(opticFinder3, typed2 -> typed2.update(DSL.remainderFinder(), dynamic -> this.fixTag(typed.get(DSL.remainderFinder()), dynamic))));
    }
    ...
    private Dynamic<?> fixTag(final Dynamic<?> dynamic1, Dynamic<?> dynamic2) {
        ...
        if (ChunkStructuresTemplateRenameFix.RENAMES.containsKey(string4)) {
            final Pair<String, ImmutableMap<String, String>> pair5 = (Pair<String, ImmutableMap<String, String>>)ChunkStructuresTemplateRenameFix.RENAMES.get(string4);
            if (((String)pair5.getFirst()).equals(dynamic2.get("id").asString(""))) {
                final String string5 = dynamic2.get("Template").asString("");
                dynamic2 = dynamic2.set("Template", dynamic2.createString((String)((ImmutableMap)pair5.getSecond()).getOrDefault(string5, string5)));
            }
        }
        return dynamic2;
    }
