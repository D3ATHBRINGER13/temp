...
public class EntityIdFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", (Type)type4, (Type)type5), this.fixTypeEverywhere("EntityIdFix", (Type)taggedChoiceType2, (Type)taggedChoiceType3, dynamicOps -> pair -> pair.mapFirst(string -> (String)EntityIdFix.ID_MAP.getOrDefault(string, string))));
    }
