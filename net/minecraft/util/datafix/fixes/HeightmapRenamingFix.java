...
public class HeightmapRenamingFix extends DataFix {
    ...
    private Dynamic<?> fix(final Dynamic<?> dynamic) {
        final Optional<? extends Dynamic<?>> optional3 = dynamic.get("Heightmaps").get();
        if (!optional3.isPresent()) {
            return dynamic;
        }
        Dynamic<?> dynamic2 = optional3.get();
        final Optional<? extends Dynamic<?>> optional4 = dynamic2.get("LIQUID").get();
        if (optional4.isPresent()) {
            dynamic2 = dynamic2.remove("LIQUID");
            dynamic2 = dynamic2.set("WORLD_SURFACE_WG", (Dynamic)optional4.get());
        }
        final Optional<? extends Dynamic<?>> optional5 = dynamic2.get("SOLID").get();
        ...
        final Optional<? extends Dynamic<?>> optional6 = dynamic2.get("LIGHT").get();
        if (optional6.isPresent()) {
            dynamic2 = dynamic2.remove("LIGHT");
            dynamic2 = dynamic2.set("LIGHT_BLOCKING", (Dynamic)optional6.get());
        }
        final Optional<? extends Dynamic<?>> optional7 = dynamic2.get("RAIN").get();
