...
public class ItemCustomNameToComponentFix extends DataFix {
    ...
    private Dynamic<?> fixTag(final Dynamic<?> dynamic) {
        final Optional<? extends Dynamic<?>> optional3 = dynamic.get("display").get();
        if (optional3.isPresent()) {
            Dynamic<?> dynamic2 = optional3.get();
            final Optional<String> optional4 = (Optional<String>)dynamic2.get("Name").asString();
            if (optional4.isPresent()) {
                dynamic2 = dynamic2.set("Name", dynamic2.createString(Component.Serializer.toJson(new TextComponent((String)optional4.get()))));
            }
            else {
                final Optional<String> optional5 = (Optional<String>)dynamic2.get("LocName").asString();
                if (optional5.isPresent()) {
                    dynamic2 = dynamic2.set("Name", dynamic2.createString(Component.Serializer.toJson(new TranslatableComponent((String)optional5.get(), new Object[0]))));
