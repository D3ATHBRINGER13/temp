...
public class ItemIdFix extends DataFix {
    ...
    public static String getItem(final int integer) {
        return (String)ItemIdFix.ITEM_NAMES.get(integer);
    }
    
    public TypeRewriteRule makeRule() {
        final Type<Either<Integer, Pair<String, String>>> type2 = (Type<Either<Integer, Pair<String, String>>>)DSL.or(DSL.intType(), DSL.named(References.ITEM_NAME.typeName(), DSL.namespacedString()));
        final Type<Pair<String, String>> type3 = (Type<Pair<String, String>>)DSL.named(References.ITEM_NAME.typeName(), DSL.namespacedString());
        final OpticFinder<Either<Integer, Pair<String, String>>> opticFinder4 = (OpticFinder<Either<Integer, Pair<String, String>>>)DSL.fieldFinder("id", (Type)type2);
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(References.ITEM_STACK), this.getOutputSchema().getType(References.ITEM_STACK), typed -> typed.update(opticFinder4, type3, either -> (Pair)either.map(integer -> Pair.of(References.ITEM_NAME.typeName(), getItem(integer)), pair -> pair)));
    }
    
    static {
        ITEM_NAMES = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
