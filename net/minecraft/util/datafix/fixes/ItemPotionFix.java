...
public class ItemPotionFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemPotionFix", (Type)type2, typed -> {
            ...
            if (optional4.isPresent() && Objects.equals(((Pair)optional4.get()).getSecond(), "minecraft:potion")) {
                ...
                if (optional5.isPresent()) {
                    Typed<?> typed2 = typed;
                    final Dynamic<?> dynamic6 = ((Typed)optional5.get()).get(DSL.remainderFinder());
                    final Optional<String> optional6 = (Optional<String>)dynamic6.get("Potion").asString();
                    if (!optional6.isPresent()) {
                        final String string11 = ItemPotionFix.POTIONS[short7 & 0x7F];
                        final Typed<?> typed3 = ((Typed)optional5.get()).set(DSL.remainderFinder(), dynamic6.set("Potion", dynamic6.createString((string11 == null) ? "minecraft:water" : string11)));
                        typed2 = typed2.set(opticFinder4, (Typed)typed3);
                        if ((short7 & 0x4000) == 0x4000) {
                            typed2 = typed2.set(opticFinder3, Pair.of((Object)References.ITEM_NAME.typeName(), "minecraft:splash_potion"));
                        }
                    }
                    if (short7 != 0) {
    ...
    static {
        POTIONS = (String[])DataFixUtils.make(new String[128], arr -> {
