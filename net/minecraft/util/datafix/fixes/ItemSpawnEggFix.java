        ...
        return this.fixTypeEverywhereTyped("ItemSpawnEggFix", (Type)type3, typed -> {
            ...
            if (optional8.isPresent() && Objects.equals(((Pair)optional8.get()).getSecond(), "minecraft:spawn_egg")) {
                ...
                if (string16 != null && (!optional12.isPresent() || !Objects.equals(optional12.get(), string16))) {
                    ...
                    final Dynamic<?> dynamic10 = typed5.write().set("id", dynamic9.createString(string16));
                    final Typed<?> typed6 = ((Optional)this.getOutputSchema().getTypeRaw(References.ENTITY).readTyped((Dynamic)dynamic10).getSecond()).orElseThrow(() -> new IllegalStateException("Could not parse new entity"));
