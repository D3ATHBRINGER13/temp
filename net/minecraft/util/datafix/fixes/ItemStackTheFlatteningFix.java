...
public class ItemStackTheFlatteningFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", (Type)type2, typed -> {
            ...
            final String string8 = updateItem((String)((Pair)optional4.get()).getSecond(), integer7);
            if (string8 != null) {
                typed2 = typed2.set(opticFinder3, Pair.of((Object)References.ITEM_NAME.typeName(), (Object)string8));
            }
            if (ItemStackTheFlatteningFix.DAMAGE_IDS.contains(((Pair)optional4.get()).getSecond())) {
                ...
                typed2 = typed2.set(opticFinder4, typed3.set(DSL.remainderFinder(), dynamic7));
            }
            typed2 = typed2.set(DSL.remainderFinder(), dynamic6.remove("Damage"));
            return typed2;
        });
    }
