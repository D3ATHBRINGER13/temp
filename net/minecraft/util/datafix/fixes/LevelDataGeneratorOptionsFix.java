...
public class LevelDataGeneratorOptionsFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("LevelDataGeneratorOptionsFix", this.getInputSchema().getType(References.LEVEL), (Type)type2, typed -> {
            final Dynamic<?> dynamic3 = typed.write();
            final Optional<String> optional4 = (Optional<String>)dynamic3.get("generatorOptions").asString();
            Dynamic<?> dynamic4;
            if ("flat".equalsIgnoreCase(dynamic3.get("generatorName").asString(""))) {
                final String string6 = (String)optional4.orElse("");
                ...
                final Dynamic<JsonElement> dynamic5 = (Dynamic<JsonElement>)new Dynamic((DynamicOps)JsonOps.INSTANCE, GsonHelper.parse((String)optional4.get(), true));
