    ...
    private static Stream<? extends Dynamic<?>> updateChildren(final Stream<? extends Dynamic<?>> stream) {
        return stream.map(dynamic -> {
            ...
            if ("ViF".equals(string2)) {
                return SavedDataVillageCropFix.updateSingleField((com.mojang.datafixers.Dynamic<Object>)dynamic);
            }
            if ("ViDF".equals(string2)) {
                return SavedDataVillageCropFix.updateDoubleField((com.mojang.datafixers.Dynamic<Object>)dynamic);
            }
            return dynamic;
        });
    }
