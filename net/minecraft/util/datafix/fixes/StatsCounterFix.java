...
public class StatsCounterFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("StatsCounterFix", this.getInputSchema().getType(References.STATS), (Type)type2, typed -> {
            ...
            final Optional<? extends Map<? extends Dynamic<?>, ? extends Dynamic<?>>> optional6 = dynamic4.getMapValues();
            if (optional6.isPresent()) {
                for (final Map.Entry<? extends Dynamic<?>, ? extends Dynamic<?>> entry8 : ((Map)optional6.get()).entrySet()) {
                    if (((Dynamic)entry8.getValue()).asNumber().isPresent()) {
            ...
            return (Typed)((Optional)type2.readTyped(dynamic4.emptyMap().set("stats", dynamic4.createMap((Map)map5))).getSecond()).orElseThrow(() -> new IllegalStateException("Could not parse new stats object."));
        });
    }
