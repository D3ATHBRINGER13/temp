...
public class VillagerTradeFix extends NamedEntityFix {
    ...
    protected Typed<?> fix(final Typed<?> typed) {
        ...
        final OpticFinder<Pair<String, String>> opticFinder9 = (OpticFinder<Pair<String, String>>)DSL.fieldFinder("id", DSL.named(References.ITEM_NAME.typeName(), DSL.namespacedString()));
