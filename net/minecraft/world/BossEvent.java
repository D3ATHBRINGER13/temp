...
public abstract class BossEvent {
    ...
    public BossEvent(final UUID uUID, final Component jo, final BossBarColor a, final BossBarOverlay b) {
        this.id = uUID;
        this.name = jo;
        this.color = a;
        this.overlay = b;
    ...
    public enum BossBarColor {
        ...
        private BossBarColor(final String string3, final ChatFormatting c) {
            this.name = string3;
            this.formatting = c;
        }
