...
public class BreakDoorGoal extends DoorInteractGoal {
    ...
    public BreakDoorGoal(final Mob aiy, final Predicate<Difficulty> predicate) {
        super(aiy);
    ...
    public BreakDoorGoal(final Mob aiy, final int integer, final Predicate<Difficulty> predicate) {
        this(aiy, predicate);
    ...
    private boolean isValidDifficulty(final Difficulty ahg) {
        return this.validDifficulties.test(ahg);
    }
}
