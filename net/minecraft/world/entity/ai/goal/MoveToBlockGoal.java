...
public abstract class MoveToBlockGoal extends Goal {
    ...
    public MoveToBlockGoal(final PathfinderMob aje, final double double2, final int integer) {
        this(aje, double2, integer, 1);
    }
    
    public MoveToBlockGoal(final PathfinderMob aje, final double double2, final int integer3, final int integer4) {
    ...
    protected int nextStartTick(final PathfinderMob aje) {
        return 200 + aje.getRandom().nextInt(200);
    }
    ...
    protected boolean findNearestBlock() {
        ...
        final BlockPos ew4 = new BlockPos(this.mob);
            ...
            for (int integer5 = 0; integer5 < integer2; ++integer5) {
                for (int integer6 = 0; integer6 <= integer5; integer6 = ((integer6 > 0) ? (-integer6) : (1 - integer6))) {
                    for (int integer7 = (integer6 < integer5 && integer6 > -integer5) ? integer5 : 0; integer7 <= integer5; integer7 = ((integer7 > 0) ? (-integer7) : (1 - integer7))) {
                        a5.set(ew4).move(integer6, integer4 - 1, integer7);
    ...
    protected abstract boolean isValidTarget(final LevelReader bhu, final BlockPos ew);
}
