...
public class TemptGoal extends Goal {
    ...
    public TemptGoal(final PathfinderMob aje, final double double2, final Ingredient beo, final boolean boolean4) {
        this(aje, double2, boolean4, beo);
    }
    
    public TemptGoal(final PathfinderMob aje, final double double2, final boolean boolean3, final Ingredient beo) {
        this.mob = aje;
    ...
    protected boolean shouldFollowItem(final ItemStack bcj) {
        return this.items.test(bcj);
    }
