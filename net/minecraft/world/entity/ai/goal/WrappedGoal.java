...
public class WrappedGoal extends Goal {
    ...
    public WrappedGoal(final int integer, final Goal ane) {
        this.priority = integer;
        this.goal = ane;
    }
    
    public boolean canBeReplacedBy(final WrappedGoal aot) {
        return this.isInterruptable() && aot.getPriority() < this.getPriority();
    }
