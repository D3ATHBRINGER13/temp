...
public class NonTameRandomTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
    ...
    public NonTameRandomTargetGoal(final TamableAnimal ajl, final Class<T> class2, final boolean boolean3, @Nullable final Predicate<LivingEntity> predicate) {
        super(ajl, class2, 10, boolean3, false, predicate);
        this.tamableMob = ajl;
    }
