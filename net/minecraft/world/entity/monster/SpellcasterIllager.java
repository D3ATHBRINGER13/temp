...
public abstract class SpellcasterIllager extends AbstractIllager {
    ...
    protected SpellcasterIllager(final EntityType<? extends SpellcasterIllager> ais, final Level bhr) {
        super(ais, bhr);
    ...
    public void readAdditionalSaveData(final CompoundTag id) {
        ...
        this.spellCastingTickCount = id.getInt("SpellTicks");
    }
    
    @Override
    public void addAdditionalSaveData(final CompoundTag id) {
        super.addAdditionalSaveData(id);
        id.putInt("SpellTicks", this.spellCastingTickCount);
    }
    ...
    public void tick() {
        ...
        if (this.level.isClientSide && this.isCastingSpell()) {
            ...
            this.level.addParticle(ParticleTypes.ENTITY_EFFECT, this.x + float10 * 0.6, this.y + 1.8, this.z + float11 * 0.6, double3, double4, double5);
            this.level.addParticle(ParticleTypes.ENTITY_EFFECT, this.x - float10 * 0.6, this.y + 1.8, this.z - float11 * 0.6, double3, double4, double5);
        }
    }
    ...
    public abstract class SpellcasterUseSpellGoal extends Goal {
        ...
        @Override
        public boolean canUse() {
            final LivingEntity aix2 = SpellcasterIllager.this.getTarget();
            return aix2 != null && aix2.isAlive() && !SpellcasterIllager.this.isCastingSpell() && SpellcasterIllager.this.tickCount >= this.nextAttackTickCount;
        }
        
        @Override
        public boolean canContinueToUse() {
            final LivingEntity aix2 = SpellcasterIllager.this.getTarget();
            return aix2 != null && aix2.isAlive() && this.attackWarmupDelay > 0;
        }
        ...
        public void start() {
            ...
            final SoundEvent yo2 = this.getSpellPrepareSound();
            if (yo2 != null) {
                SpellcasterIllager.this.playSound(yo2, 1.0f, 1.0f);
            }
