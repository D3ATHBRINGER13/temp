...
public class VillagerTrades {
    ...
    static class EmeraldForItems implements ItemListing {
        ...
        public EmeraldForItems(final ItemLike bhq, final int integer2, final int integer3, final int integer4) {
        ...
        public MerchantOffer getOffer(final Entity aio, final Random random) {
            final ItemStack bcj4 = new ItemStack(this.item, this.cost);
            return new MerchantOffer(bcj4, new ItemStack(Items.EMERALD), this.maxUses, this.villagerXp, this.priceMultiplier);
        }
    }
    ...
    static class EmeraldsForVillagerTypeItem implements ItemListing {
        ...
        public EmeraldsForVillagerTypeItem(final int integer1, final int integer2, final int integer3, final Map<VillagerType, Item> map) {
            Registry.VILLAGER_TYPE.stream().filter(avy -> !map.containsKey(avy)).findAny().ifPresent(avy -> {
                throw new IllegalStateException(new StringBuilder().append("Missing trade for villager type: ").append(Registry.VILLAGER_TYPE.getKey(avy)).toString());
            });
            this.trades = map;
            this.cost = integer1;
        ...
        @Nullable
        public MerchantOffer getOffer(final Entity aio, final Random random) {
            if (aio instanceof VillagerDataHolder) {
                final ItemStack bcj4 = new ItemStack((ItemLike)this.trades.get(((VillagerDataHolder)aio).getVillagerData().getType()), this.cost);
                return new MerchantOffer(bcj4, new ItemStack(Items.EMERALD), this.maxUses, this.villagerXp, 0.05f);
            }
            return null;
        }
    }
    ...
    static class ItemsForEmeralds implements ItemListing {
        ...
        public ItemsForEmeralds(final Block bmv, final int integer2, final int integer3, final int integer4, final int integer5) {
            this(new ItemStack(bmv), integer2, integer3, integer4, integer5);
        }
        
        public ItemsForEmeralds(final Item bce, final int integer2, final int integer3, final int integer4) {
            this(new ItemStack(bce), integer2, integer3, 12, integer4);
        }
        
        public ItemsForEmeralds(final Item bce, final int integer2, final int integer3, final int integer4, final int integer5) {
            this(new ItemStack(bce), integer2, integer3, integer4, integer5);
        }
        
        public ItemsForEmeralds(final ItemStack bcj, final int integer2, final int integer3, final int integer4, final int integer5) {
            this(bcj, integer2, integer3, integer4, integer5, 0.05f);
        }
        
        public ItemsForEmeralds(final ItemStack bcj, final int integer2, final int integer3, final int integer4, final int integer5, final float float6) {
            this.itemStack = bcj;
    ...
    static class SuspisciousStewForEmerald implements ItemListing {
        ...
        public SuspisciousStewForEmerald(final MobEffect aig, final int integer2, final int integer3) {
            this.effect = aig;
        ...
        @Nullable
        public MerchantOffer getOffer(final Entity aio, final Random random) {
            final ItemStack bcj4 = new ItemStack(Items.SUSPICIOUS_STEW, 1);
            SuspiciousStewItem.saveMobEffect(bcj4, this.effect, this.duration);
            return new MerchantOffer(new ItemStack(Items.EMERALD, 1), bcj4, 12, this.xp, this.priceMultiplier);
        }
    }
    ...
    static class EnchantedItemForEmeralds implements ItemListing {
        ...
        public EnchantedItemForEmeralds(final Item bce, final int integer2, final int integer3, final int integer4) {
            this(bce, integer2, integer3, integer4, 0.05f);
        }
        
        public EnchantedItemForEmeralds(final Item bce, final int integer2, final int integer3, final int integer4, final float float5) {
            this.itemStack = new ItemStack(bce);
        ...
        public MerchantOffer getOffer(final Entity aio, final Random random) {
            ...
            final ItemStack bcj5 = EnchantmentHelper.enchantItem(random, new ItemStack(this.itemStack.getItem()), integer4, false);
            final int integer5 = Math.min(this.baseEmeraldCost + integer4, 64);
            final ItemStack bcj6 = new ItemStack(Items.EMERALD, integer5);
            return new MerchantOffer(bcj6, bcj5, this.maxUses, this.villagerXp, this.priceMultiplier);
        }
    }
    ...
    static class TippedArrowForItemsAndEmeralds implements ItemListing {
        ...
        public TippedArrowForItemsAndEmeralds(final Item bce1, final int integer2, final Item bce3, final int integer4, final int integer5, final int integer6, final int integer7) {
            this.toItem = new ItemStack(bce3);
        ...
        public MerchantOffer getOffer(final Entity aio, final Random random) {
            final ItemStack bcj4 = new ItemStack(Items.EMERALD, this.emeraldCost);
            final List<Potion> list5 = (List<Potion>)Registry.POTION.stream().filter(bdy -> !bdy.getEffects().isEmpty() && PotionBrewing.isBrewablePotion(bdy)).collect(Collectors.toList());
            final Potion bdy6 = (Potion)list5.get(random.nextInt(list5.size()));
            final ItemStack bcj5 = PotionUtils.setPotion(new ItemStack(this.toItem.getItem(), this.toCount), bdy6);
            return new MerchantOffer(bcj4, new ItemStack(this.fromItem, this.fromCount), bcj5, this.maxUses, this.villagerXp, this.priceMultiplier);
        }
    }
    ...
    static class DyedArmorForEmeralds implements ItemListing {
        ...
        public DyedArmorForEmeralds(final Item bce, final int integer) {
            this(bce, integer, 12, 1);
        }
        
        public DyedArmorForEmeralds(final Item bce, final int integer2, final int integer3, final int integer4) {
            this.item = bce;
            this.value = integer2;
            this.maxUses = integer3;
            this.villagerXp = integer4;
        ...
        public MerchantOffer getOffer(final Entity aio, final Random random) {
            final ItemStack bcj4 = new ItemStack(Items.EMERALD, this.value);
            ItemStack bcj5 = new ItemStack(this.item);
            if (this.item instanceof DyeableArmorItem) {
                ...
                bcj5 = DyeableLeatherItem.dyeArmor(bcj5, list6);
            }
            return new MerchantOffer(bcj4, bcj5, this.maxUses, this.villagerXp, 0.2f);
        }
    ...
    static class EnchantBookForEmeralds implements ItemListing {
        ...
        public MerchantOffer getOffer(final Entity aio, final Random random) {
            final Enchantment bfs4 = Registry.ENCHANTMENT.getRandom(random);
            final int integer5 = Mth.nextInt(random, bfs4.getMinLevel(), bfs4.getMaxLevel());
            final ItemStack bcj6 = EnchantedBookItem.createForEnchantment(new EnchantmentInstance(bfs4, integer5));
            int integer6 = 2 + random.nextInt(5 + integer5 * 10) + 3 * integer5;
            if (bfs4.isTreasureOnly()) {
                integer6 *= 2;
            }
            if (integer6 > 64) {
                integer6 = 64;
            }
            return new MerchantOffer(new ItemStack(Items.EMERALD, integer6), new ItemStack(Items.BOOK), bcj6, 12, this.villagerXp, 0.2f);
        }
    }
    ...
    static class TreasureMapForEmeralds implements ItemListing {
        ...
        @Nullable
        public MerchantOffer getOffer(final Entity aio, final Random random) {
            final Level bhr4 = aio.level;
            final BlockPos ew5 = bhr4.findNearestMapFeature(this.destination, new BlockPos(aio), 100, true);
            if (ew5 != null) {
                final ItemStack bcj6 = MapItem.create(bhr4, ew5.getX(), ew5.getZ(), (byte)2, true, true);
                MapItem.renderBiomePreviewMap(bhr4, bcj6);
                MapItemSavedData.addTargetDecoration(bcj6, ew5, "+", this.destinationType);
                bcj6.setHoverName(new TranslatableComponent("filled_map." + this.destination.toLowerCase(Locale.ROOT), new Object[0]));
                return new MerchantOffer(new ItemStack(Items.EMERALD, this.emeraldCost), new ItemStack(Items.COMPASS), bcj6, this.maxUses, this.villagerXp, 0.2f);
            }
            return null;
        }
    }
    ...
    static class ItemsAndEmeraldsToItems implements ItemListing {
        ...
        public ItemsAndEmeraldsToItems(final ItemLike bhq, final int integer2, final Item bce, final int integer4, final int integer5, final int integer6) {
            this(bhq, integer2, 1, bce, integer4, integer5, integer6);
        }
        
        public ItemsAndEmeraldsToItems(final ItemLike bhq, final int integer2, final int integer3, final Item bce, final int integer5, final int integer6, final int integer7) {
            this.fromItem = new ItemStack(bhq);
            this.fromCount = integer2;
            this.emeraldCost = integer3;
            this.toItem = new ItemStack(bce);
    ...
    public interface ItemListing {
        @Nullable
        MerchantOffer getOffer(final Entity aio, final Random random);
    }
}
