...
public class MinecartCommandBlock extends AbstractMinecart {
    ...
    public MinecartCommandBlock(final EntityType<? extends MinecartCommandBlock> ais, final Level bhr) {
        super(ais, bhr);
        this.commandBlock = new MinecartCommandBase();
    }
    
    public MinecartCommandBlock(final Level bhr, final double double2, final double double3, final double double4) {
        super(EntityType.COMMAND_BLOCK_MINECART, bhr, double2, double3, double4);
        this.commandBlock = new MinecartCommandBase();
    }
    ...
    protected void defineSynchedData() {
        ...
        this.getEntityData().<TextComponent>define((EntityDataAccessor<TextComponent>)MinecartCommandBlock.DATA_ID_LAST_OUTPUT, new TextComponent(""));
    }
    ...
    public void onSyncedDataUpdated(final EntityDataAccessor<?> qk) {
        ...
        if (MinecartCommandBlock.DATA_ID_LAST_OUTPUT.equals(qk)) {
            try {
                this.commandBlock.setLastOutput(this.getEntityData().<Component>get(MinecartCommandBlock.DATA_ID_LAST_OUTPUT));
            }
            catch (Throwable t) {}
        }
        else if (MinecartCommandBlock.DATA_ID_COMMAND_NAME.equals(qk)) {
