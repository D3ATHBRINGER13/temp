...
public class MenuType<T extends AbstractContainerMenu> {
    ...
    public static final MenuType<CartographyMenu> CARTOGRAPHY;
    ...
    public T create(final int integer, final Inventory awf) {
        return this.constructor.create(integer, awf);
    }
    ...
    static {
        ...
        LECTERN = MenuType.<LecternMenu>register("lectern", (integer, awf) -> new LecternMenu(integer));
        ...
        CARTOGRAPHY = MenuType.<CartographyMenu>register("cartography", CartographyMenu::new);
    ...
    interface MenuSupplier<T extends AbstractContainerMenu> {
        T create(final int integer, final Inventory awf);
    }
}
