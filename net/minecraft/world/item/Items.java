...
public class Items {
    ...
    private static Item registerBlock(final Block bmv) {
        return registerBlock(new BlockItem(bmv, new Item.Properties()));
    }
    
    private static Item registerBlock(final Block bmv, final CreativeModeTab bba) {
        return registerBlock(new BlockItem(bmv, new Item.Properties().tab(bba)));
    }
    
    private static Item registerBlock(final BlockItem bam) {
        return registerBlock(bam.getBlock(), bam);
    }
    
    protected static Item registerBlock(final Block bmv, final Item bce) {
        return registerItem(Registry.BLOCK.getKey(bmv), bce);
    }
    
    private static Item registerItem(final String string, final Item bce) {
        return registerItem(new ResourceLocation(string), bce);
    }
    
    private static Item registerItem(final ResourceLocation qv, final Item bce) {
        if (bce instanceof BlockItem) {
            ((BlockItem)bce).registerBlocks(Item.BY_BLOCK, bce);
        }
        return Registry.<Item>register(Registry.ITEM, qv, bce);
    }
    
    static {
        AIR = registerBlock(Blocks.AIR, new AirItem(Blocks.AIR, new Item.Properties()));
        ...
        TORCH = registerBlock(new StandingAndWallBlockItem(Blocks.TORCH, Blocks.WALL_TORCH, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        ...
        REDSTONE_TORCH = registerBlock(new StandingAndWallBlockItem(Blocks.REDSTONE_TORCH, Blocks.REDSTONE_WALL_TORCH, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
        ...
        LILY_PAD = registerBlock(new WaterLilyBlockItem(Blocks.LILY_PAD, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        ...
        COMMAND_BLOCK = registerBlock(new GameMasterBlockItem(Blocks.COMMAND_BLOCK, new Item.Properties().rarity(Rarity.EPIC)));
        ...
        SUNFLOWER = registerBlock(new DoubleHighBlockItem(Blocks.SUNFLOWER, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        LILAC = registerBlock(new DoubleHighBlockItem(Blocks.LILAC, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        ROSE_BUSH = registerBlock(new DoubleHighBlockItem(Blocks.ROSE_BUSH, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        PEONY = registerBlock(new DoubleHighBlockItem(Blocks.PEONY, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        TALL_GRASS = registerBlock(new DoubleHighBlockItem(Blocks.TALL_GRASS, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        LARGE_FERN = registerBlock(new DoubleHighBlockItem(Blocks.LARGE_FERN, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        ...
        REPEATING_COMMAND_BLOCK = registerBlock(new GameMasterBlockItem(Blocks.REPEATING_COMMAND_BLOCK, new Item.Properties().rarity(Rarity.EPIC)));
        CHAIN_COMMAND_BLOCK = registerBlock(new GameMasterBlockItem(Blocks.CHAIN_COMMAND_BLOCK, new Item.Properties().rarity(Rarity.EPIC)));
        ...
        TUBE_CORAL_FAN = registerBlock(new StandingAndWallBlockItem(Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        BRAIN_CORAL_FAN = registerBlock(new StandingAndWallBlockItem(Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        BUBBLE_CORAL_FAN = registerBlock(new StandingAndWallBlockItem(Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        FIRE_CORAL_FAN = registerBlock(new StandingAndWallBlockItem(Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        HORN_CORAL_FAN = registerBlock(new StandingAndWallBlockItem(Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        DEAD_TUBE_CORAL_FAN = registerBlock(new StandingAndWallBlockItem(Blocks.DEAD_TUBE_CORAL_FAN, Blocks.DEAD_TUBE_CORAL_WALL_FAN, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        DEAD_BRAIN_CORAL_FAN = registerBlock(new StandingAndWallBlockItem(Blocks.DEAD_BRAIN_CORAL_FAN, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        DEAD_BUBBLE_CORAL_FAN = registerBlock(new StandingAndWallBlockItem(Blocks.DEAD_BUBBLE_CORAL_FAN, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        DEAD_FIRE_CORAL_FAN = registerBlock(new StandingAndWallBlockItem(Blocks.DEAD_FIRE_CORAL_FAN, Blocks.DEAD_FIRE_CORAL_WALL_FAN, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        DEAD_HORN_CORAL_FAN = registerBlock(new StandingAndWallBlockItem(Blocks.DEAD_HORN_CORAL_FAN, Blocks.DEAD_HORN_CORAL_WALL_FAN, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        ...
        SCAFFOLDING = registerBlock(new ScaffoldingBlockItem(Blocks.SCAFFOLDING, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        IRON_DOOR = registerBlock(new DoubleHighBlockItem(Blocks.IRON_DOOR, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
        OAK_DOOR = registerBlock(new DoubleHighBlockItem(Blocks.OAK_DOOR, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
        SPRUCE_DOOR = registerBlock(new DoubleHighBlockItem(Blocks.SPRUCE_DOOR, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
        BIRCH_DOOR = registerBlock(new DoubleHighBlockItem(Blocks.BIRCH_DOOR, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
        JUNGLE_DOOR = registerBlock(new DoubleHighBlockItem(Blocks.JUNGLE_DOOR, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
        ACACIA_DOOR = registerBlock(new DoubleHighBlockItem(Blocks.ACACIA_DOOR, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
        DARK_OAK_DOOR = registerBlock(new DoubleHighBlockItem(Blocks.DARK_OAK_DOOR, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
        ...
        STRUCTURE_BLOCK = registerBlock(new GameMasterBlockItem(Blocks.STRUCTURE_BLOCK, new Item.Properties().rarity(Rarity.EPIC)));
        JIGSAW_BLOCK = registerBlock(new GameMasterBlockItem(Blocks.JIGSAW_BLOCK, new Item.Properties().rarity(Rarity.EPIC)));
        COMPOSTER = registerBlock(Blocks.COMPOSTER, CreativeModeTab.TAB_MISC);
        TURTLE_HELMET = registerItem("turtle_helmet", (Item)new ArmorItem(ArmorMaterials.TURTLE, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        SCUTE = registerItem("scute", new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        IRON_SHOVEL = registerItem("iron_shovel", (Item)new ShovelItem(Tiers.IRON, 1.5f, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        IRON_PICKAXE = registerItem("iron_pickaxe", (Item)new PickaxeItem(Tiers.IRON, 1, -2.8f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        IRON_AXE = registerItem("iron_axe", (Item)new AxeItem(Tiers.IRON, 6.0f, -3.1f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        FLINT_AND_STEEL = registerItem("flint_and_steel", (Item)new FlintAndSteelItem(new Item.Properties().durability(64).tab(CreativeModeTab.TAB_TOOLS)));
        APPLE = registerItem("apple", new Item(new Item.Properties().tab(CreativeModeTab.TAB_FOOD).food(Foods.APPLE)));
        BOW = registerItem("bow", (Item)new BowItem(new Item.Properties().durability(384).tab(CreativeModeTab.TAB_COMBAT)));
        ARROW = registerItem("arrow", (Item)new ArrowItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        ...
        IRON_SWORD = registerItem("iron_sword", (Item)new SwordItem(Tiers.IRON, 3, -2.4f, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        WOODEN_SWORD = registerItem("wooden_sword", (Item)new SwordItem(Tiers.WOOD, 3, -2.4f, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        WOODEN_SHOVEL = registerItem("wooden_shovel", (Item)new ShovelItem(Tiers.WOOD, 1.5f, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        WOODEN_PICKAXE = registerItem("wooden_pickaxe", (Item)new PickaxeItem(Tiers.WOOD, 1, -2.8f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        WOODEN_AXE = registerItem("wooden_axe", (Item)new AxeItem(Tiers.WOOD, 6.0f, -3.2f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        STONE_SWORD = registerItem("stone_sword", (Item)new SwordItem(Tiers.STONE, 3, -2.4f, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        STONE_SHOVEL = registerItem("stone_shovel", (Item)new ShovelItem(Tiers.STONE, 1.5f, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        STONE_PICKAXE = registerItem("stone_pickaxe", (Item)new PickaxeItem(Tiers.STONE, 1, -2.8f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        STONE_AXE = registerItem("stone_axe", (Item)new AxeItem(Tiers.STONE, 7.0f, -3.2f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        DIAMOND_SWORD = registerItem("diamond_sword", (Item)new SwordItem(Tiers.DIAMOND, 3, -2.4f, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        DIAMOND_SHOVEL = registerItem("diamond_shovel", (Item)new ShovelItem(Tiers.DIAMOND, 1.5f, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        DIAMOND_PICKAXE = registerItem("diamond_pickaxe", (Item)new PickaxeItem(Tiers.DIAMOND, 1, -2.8f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        DIAMOND_AXE = registerItem("diamond_axe", (Item)new AxeItem(Tiers.DIAMOND, 5.0f, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        ...
        MUSHROOM_STEW = registerItem("mushroom_stew", (Item)new BowlFoodItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_FOOD).food(Foods.MUSHROOM_STEW)));
        GOLDEN_SWORD = registerItem("golden_sword", (Item)new SwordItem(Tiers.GOLD, 3, -2.4f, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        GOLDEN_SHOVEL = registerItem("golden_shovel", (Item)new ShovelItem(Tiers.GOLD, 1.5f, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        GOLDEN_PICKAXE = registerItem("golden_pickaxe", (Item)new PickaxeItem(Tiers.GOLD, 1, -2.8f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        GOLDEN_AXE = registerItem("golden_axe", (Item)new AxeItem(Tiers.GOLD, 6.0f, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        STRING = registerItem("string", (Item)new ItemNameBlockItem(Blocks.TRIPWIRE, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ...
        WOODEN_HOE = registerItem("wooden_hoe", (Item)new HoeItem(Tiers.WOOD, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        STONE_HOE = registerItem("stone_hoe", (Item)new HoeItem(Tiers.STONE, -2.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        IRON_HOE = registerItem("iron_hoe", (Item)new HoeItem(Tiers.IRON, -1.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        DIAMOND_HOE = registerItem("diamond_hoe", (Item)new HoeItem(Tiers.DIAMOND, 0.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        GOLDEN_HOE = registerItem("golden_hoe", (Item)new HoeItem(Tiers.GOLD, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        WHEAT_SEEDS = registerItem("wheat_seeds", (Item)new ItemNameBlockItem(Blocks.WHEAT, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        ...
        LEATHER_HELMET = registerItem("leather_helmet", (Item)new DyeableArmorItem(ArmorMaterials.LEATHER, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        LEATHER_CHESTPLATE = registerItem("leather_chestplate", (Item)new DyeableArmorItem(ArmorMaterials.LEATHER, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        LEATHER_LEGGINGS = registerItem("leather_leggings", (Item)new DyeableArmorItem(ArmorMaterials.LEATHER, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        LEATHER_BOOTS = registerItem("leather_boots", (Item)new DyeableArmorItem(ArmorMaterials.LEATHER, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        CHAINMAIL_HELMET = registerItem("chainmail_helmet", (Item)new ArmorItem(ArmorMaterials.CHAIN, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        CHAINMAIL_CHESTPLATE = registerItem("chainmail_chestplate", (Item)new ArmorItem(ArmorMaterials.CHAIN, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        CHAINMAIL_LEGGINGS = registerItem("chainmail_leggings", (Item)new ArmorItem(ArmorMaterials.CHAIN, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        CHAINMAIL_BOOTS = registerItem("chainmail_boots", (Item)new ArmorItem(ArmorMaterials.CHAIN, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        IRON_HELMET = registerItem("iron_helmet", (Item)new ArmorItem(ArmorMaterials.IRON, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        IRON_CHESTPLATE = registerItem("iron_chestplate", (Item)new ArmorItem(ArmorMaterials.IRON, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        IRON_LEGGINGS = registerItem("iron_leggings", (Item)new ArmorItem(ArmorMaterials.IRON, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        IRON_BOOTS = registerItem("iron_boots", (Item)new ArmorItem(ArmorMaterials.IRON, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        DIAMOND_HELMET = registerItem("diamond_helmet", (Item)new ArmorItem(ArmorMaterials.DIAMOND, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        DIAMOND_CHESTPLATE = registerItem("diamond_chestplate", (Item)new ArmorItem(ArmorMaterials.DIAMOND, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        DIAMOND_LEGGINGS = registerItem("diamond_leggings", (Item)new ArmorItem(ArmorMaterials.DIAMOND, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        DIAMOND_BOOTS = registerItem("diamond_boots", (Item)new ArmorItem(ArmorMaterials.DIAMOND, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        GOLDEN_HELMET = registerItem("golden_helmet", (Item)new ArmorItem(ArmorMaterials.GOLD, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        GOLDEN_CHESTPLATE = registerItem("golden_chestplate", (Item)new ArmorItem(ArmorMaterials.GOLD, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        GOLDEN_LEGGINGS = registerItem("golden_leggings", (Item)new ArmorItem(ArmorMaterials.GOLD, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        GOLDEN_BOOTS = registerItem("golden_boots", (Item)new ArmorItem(ArmorMaterials.GOLD, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        ...
        PAINTING = registerItem("painting", (Item)new HangingEntityItem(EntityType.PAINTING, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        ...
        ENCHANTED_GOLDEN_APPLE = registerItem("enchanted_golden_apple", (Item)new EnchantedGoldenAppleItem(new Item.Properties().tab(CreativeModeTab.TAB_FOOD).rarity(Rarity.EPIC).food(Foods.ENCHANTED_GOLDEN_APPLE)));
        OAK_SIGN = registerItem("oak_sign", (Item)new SignItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.OAK_SIGN, Blocks.OAK_WALL_SIGN));
        SPRUCE_SIGN = registerItem("spruce_sign", (Item)new SignItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.SPRUCE_SIGN, Blocks.SPRUCE_WALL_SIGN));
        BIRCH_SIGN = registerItem("birch_sign", (Item)new SignItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.BIRCH_SIGN, Blocks.BIRCH_WALL_SIGN));
        JUNGLE_SIGN = registerItem("jungle_sign", (Item)new SignItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.JUNGLE_SIGN, Blocks.JUNGLE_WALL_SIGN));
        ACACIA_SIGN = registerItem("acacia_sign", (Item)new SignItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.ACACIA_SIGN, Blocks.ACACIA_WALL_SIGN));
        DARK_OAK_SIGN = registerItem("dark_oak_sign", (Item)new SignItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.DARK_OAK_SIGN, Blocks.DARK_OAK_WALL_SIGN));
        BUCKET = registerItem("bucket", (Item)new BucketItem(Fluids.EMPTY, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_MISC)));
        WATER_BUCKET = registerItem("water_bucket", (Item)new BucketItem(Fluids.WATER, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        LAVA_BUCKET = registerItem("lava_bucket", (Item)new BucketItem(Fluids.LAVA, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        MINECART = registerItem("minecart", (Item)new MinecartItem(AbstractMinecart.Type.RIDEABLE, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        SADDLE = registerItem("saddle", (Item)new SaddleItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        REDSTONE = registerItem("redstone", (Item)new ItemNameBlockItem(Blocks.REDSTONE_WIRE, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
        SNOWBALL = registerItem("snowball", (Item)new SnowballItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_MISC)));
        OAK_BOAT = registerItem("oak_boat", (Item)new BoatItem(Boat.Type.OAK, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        LEATHER = registerItem("leather", new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        MILK_BUCKET = registerItem("milk_bucket", (Item)new MilkBucketItem(new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        PUFFERFISH_BUCKET = registerItem("pufferfish_bucket", (Item)new FishBucketItem(EntityType.PUFFERFISH, Fluids.WATER, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        SALMON_BUCKET = registerItem("salmon_bucket", (Item)new FishBucketItem(EntityType.SALMON, Fluids.WATER, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        COD_BUCKET = registerItem("cod_bucket", (Item)new FishBucketItem(EntityType.COD, Fluids.WATER, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        TROPICAL_FISH_BUCKET = registerItem("tropical_fish_bucket", (Item)new FishBucketItem(EntityType.TROPICAL_FISH, Fluids.WATER, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        ...
        BOOK = registerItem("book", (Item)new BookItem(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        SLIME_BALL = registerItem("slime_ball", new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        CHEST_MINECART = registerItem("chest_minecart", (Item)new MinecartItem(AbstractMinecart.Type.CHEST, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        FURNACE_MINECART = registerItem("furnace_minecart", (Item)new MinecartItem(AbstractMinecart.Type.FURNACE, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        EGG = registerItem("egg", (Item)new EggItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_MATERIALS)));
        COMPASS = registerItem("compass", (Item)new CompassItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        FISHING_ROD = registerItem("fishing_rod", (Item)new FishingRodItem(new Item.Properties().durability(64).tab(CreativeModeTab.TAB_TOOLS)));
        CLOCK = registerItem("clock", (Item)new ClockItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        ...
        RED_DYE = registerItem("red_dye", (Item)new DyeItem(DyeColor.RED, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        GREEN_DYE = registerItem("green_dye", (Item)new DyeItem(DyeColor.GREEN, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        COCOA_BEANS = registerItem("cocoa_beans", (Item)new ItemNameBlockItem(Blocks.COCOA, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        LAPIS_LAZULI = registerItem("lapis_lazuli", new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        PURPLE_DYE = registerItem("purple_dye", (Item)new DyeItem(DyeColor.PURPLE, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        CYAN_DYE = registerItem("cyan_dye", (Item)new DyeItem(DyeColor.CYAN, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        LIGHT_GRAY_DYE = registerItem("light_gray_dye", (Item)new DyeItem(DyeColor.LIGHT_GRAY, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        GRAY_DYE = registerItem("gray_dye", (Item)new DyeItem(DyeColor.GRAY, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        PINK_DYE = registerItem("pink_dye", (Item)new DyeItem(DyeColor.PINK, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        LIME_DYE = registerItem("lime_dye", (Item)new DyeItem(DyeColor.LIME, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        YELLOW_DYE = registerItem("yellow_dye", (Item)new DyeItem(DyeColor.YELLOW, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        LIGHT_BLUE_DYE = registerItem("light_blue_dye", (Item)new DyeItem(DyeColor.LIGHT_BLUE, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        MAGENTA_DYE = registerItem("magenta_dye", (Item)new DyeItem(DyeColor.MAGENTA, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        ORANGE_DYE = registerItem("orange_dye", (Item)new DyeItem(DyeColor.ORANGE, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        BONE_MEAL = registerItem("bone_meal", (Item)new BoneMealItem(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        BLUE_DYE = registerItem("blue_dye", (Item)new DyeItem(DyeColor.BLUE, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        BROWN_DYE = registerItem("brown_dye", (Item)new DyeItem(DyeColor.BROWN, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        BLACK_DYE = registerItem("black_dye", (Item)new DyeItem(DyeColor.BLACK, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        WHITE_DYE = registerItem("white_dye", (Item)new DyeItem(DyeColor.WHITE, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        ...
        WHITE_BED = registerBlock(new BedItem(Blocks.WHITE_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        ORANGE_BED = registerBlock(new BedItem(Blocks.ORANGE_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        MAGENTA_BED = registerBlock(new BedItem(Blocks.MAGENTA_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        LIGHT_BLUE_BED = registerBlock(new BedItem(Blocks.LIGHT_BLUE_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        YELLOW_BED = registerBlock(new BedItem(Blocks.YELLOW_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        LIME_BED = registerBlock(new BedItem(Blocks.LIME_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        PINK_BED = registerBlock(new BedItem(Blocks.PINK_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        GRAY_BED = registerBlock(new BedItem(Blocks.GRAY_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        LIGHT_GRAY_BED = registerBlock(new BedItem(Blocks.LIGHT_GRAY_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        CYAN_BED = registerBlock(new BedItem(Blocks.CYAN_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        PURPLE_BED = registerBlock(new BedItem(Blocks.PURPLE_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        BLUE_BED = registerBlock(new BedItem(Blocks.BLUE_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        BROWN_BED = registerBlock(new BedItem(Blocks.BROWN_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        GREEN_BED = registerBlock(new BedItem(Blocks.GREEN_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        RED_BED = registerBlock(new BedItem(Blocks.RED_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        BLACK_BED = registerBlock(new BedItem(Blocks.BLACK_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
        COOKIE = registerItem("cookie", new Item(new Item.Properties().tab(CreativeModeTab.TAB_FOOD).food(Foods.COOKIE)));
        FILLED_MAP = registerItem("filled_map", (Item)new MapItem(new Item.Properties()));
        SHEARS = registerItem("shears", (Item)new ShearsItem(new Item.Properties().durability(238).tab(CreativeModeTab.TAB_TOOLS)));
        ...
        PUMPKIN_SEEDS = registerItem("pumpkin_seeds", (Item)new ItemNameBlockItem(Blocks.PUMPKIN_STEM, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        MELON_SEEDS = registerItem("melon_seeds", (Item)new ItemNameBlockItem(Blocks.MELON_STEM, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        ...
        ENDER_PEARL = registerItem("ender_pearl", (Item)new EnderpearlItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_MISC)));
        ...
        NETHER_WART = registerItem("nether_wart", (Item)new ItemNameBlockItem(Blocks.NETHER_WART, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        POTION = registerItem("potion", (Item)new PotionItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_BREWING)));
        GLASS_BOTTLE = registerItem("glass_bottle", (Item)new BottleItem(new Item.Properties().tab(CreativeModeTab.TAB_BREWING)));
        ...
        ENDER_EYE = registerItem("ender_eye", (Item)new EnderEyeItem(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        GLISTERING_MELON_SLICE = registerItem("glistering_melon_slice", new Item(new Item.Properties().tab(CreativeModeTab.TAB_BREWING)));
        BAT_SPAWN_EGG = registerItem("bat_spawn_egg", (Item)new SpawnEggItem(EntityType.BAT, 4996656, 986895, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        BLAZE_SPAWN_EGG = registerItem("blaze_spawn_egg", (Item)new SpawnEggItem(EntityType.BLAZE, 16167425, 16775294, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        CAT_SPAWN_EGG = registerItem("cat_spawn_egg", (Item)new SpawnEggItem(EntityType.CAT, 15714446, 9794134, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        CAVE_SPIDER_SPAWN_EGG = registerItem("cave_spider_spawn_egg", (Item)new SpawnEggItem(EntityType.CAVE_SPIDER, 803406, 11013646, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        CHICKEN_SPAWN_EGG = registerItem("chicken_spawn_egg", (Item)new SpawnEggItem(EntityType.CHICKEN, 10592673, 16711680, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        COD_SPAWN_EGG = registerItem("cod_spawn_egg", (Item)new SpawnEggItem(EntityType.COD, 12691306, 15058059, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        COW_SPAWN_EGG = registerItem("cow_spawn_egg", (Item)new SpawnEggItem(EntityType.COW, 4470310, 10592673, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        CREEPER_SPAWN_EGG = registerItem("creeper_spawn_egg", (Item)new SpawnEggItem(EntityType.CREEPER, 894731, 0, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        DOLPHIN_SPAWN_EGG = registerItem("dolphin_spawn_egg", (Item)new SpawnEggItem(EntityType.DOLPHIN, 2243405, 16382457, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        DONKEY_SPAWN_EGG = registerItem("donkey_spawn_egg", (Item)new SpawnEggItem(EntityType.DONKEY, 5457209, 8811878, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        DROWNED_SPAWN_EGG = registerItem("drowned_spawn_egg", (Item)new SpawnEggItem(EntityType.DROWNED, 9433559, 7969893, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ELDER_GUARDIAN_SPAWN_EGG = registerItem("elder_guardian_spawn_egg", (Item)new SpawnEggItem(EntityType.ELDER_GUARDIAN, 13552826, 7632531, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ENDERMAN_SPAWN_EGG = registerItem("enderman_spawn_egg", (Item)new SpawnEggItem(EntityType.ENDERMAN, 1447446, 0, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ENDERMITE_SPAWN_EGG = registerItem("endermite_spawn_egg", (Item)new SpawnEggItem(EntityType.ENDERMITE, 1447446, 7237230, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        EVOKER_SPAWN_EGG = registerItem("evoker_spawn_egg", (Item)new SpawnEggItem(EntityType.EVOKER, 9804699, 1973274, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        FOX_SPAWN_EGG = registerItem("fox_spawn_egg", (Item)new SpawnEggItem(EntityType.FOX, 14005919, 13396256, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        GHAST_SPAWN_EGG = registerItem("ghast_spawn_egg", (Item)new SpawnEggItem(EntityType.GHAST, 16382457, 12369084, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        GUARDIAN_SPAWN_EGG = registerItem("guardian_spawn_egg", (Item)new SpawnEggItem(EntityType.GUARDIAN, 5931634, 15826224, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        HORSE_SPAWN_EGG = registerItem("horse_spawn_egg", (Item)new SpawnEggItem(EntityType.HORSE, 12623485, 15656192, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        HUSK_SPAWN_EGG = registerItem("husk_spawn_egg", (Item)new SpawnEggItem(EntityType.HUSK, 7958625, 15125652, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        LLAMA_SPAWN_EGG = registerItem("llama_spawn_egg", (Item)new SpawnEggItem(EntityType.LLAMA, 12623485, 10051392, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        MAGMA_CUBE_SPAWN_EGG = registerItem("magma_cube_spawn_egg", (Item)new SpawnEggItem(EntityType.MAGMA_CUBE, 3407872, 16579584, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        MOOSHROOM_SPAWN_EGG = registerItem("mooshroom_spawn_egg", (Item)new SpawnEggItem(EntityType.MOOSHROOM, 10489616, 12040119, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        MULE_SPAWN_EGG = registerItem("mule_spawn_egg", (Item)new SpawnEggItem(EntityType.MULE, 1769984, 5321501, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        OCELOT_SPAWN_EGG = registerItem("ocelot_spawn_egg", (Item)new SpawnEggItem(EntityType.OCELOT, 15720061, 5653556, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        PANDA_SPAWN_EGG = registerItem("panda_spawn_egg", (Item)new SpawnEggItem(EntityType.PANDA, 15198183, 1776418, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        PARROT_SPAWN_EGG = registerItem("parrot_spawn_egg", (Item)new SpawnEggItem(EntityType.PARROT, 894731, 16711680, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        PHANTOM_SPAWN_EGG = registerItem("phantom_spawn_egg", (Item)new SpawnEggItem(EntityType.PHANTOM, 4411786, 8978176, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        PIG_SPAWN_EGG = registerItem("pig_spawn_egg", (Item)new SpawnEggItem(EntityType.PIG, 15771042, 14377823, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        PILLAGER_SPAWN_EGG = registerItem("pillager_spawn_egg", (Item)new SpawnEggItem(EntityType.PILLAGER, 5451574, 9804699, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        POLAR_BEAR_SPAWN_EGG = registerItem("polar_bear_spawn_egg", (Item)new SpawnEggItem(EntityType.POLAR_BEAR, 15921906, 9803152, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        PUFFERFISH_SPAWN_EGG = registerItem("pufferfish_spawn_egg", (Item)new SpawnEggItem(EntityType.PUFFERFISH, 16167425, 3654642, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        RABBIT_SPAWN_EGG = registerItem("rabbit_spawn_egg", (Item)new SpawnEggItem(EntityType.RABBIT, 10051392, 7555121, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        RAVAGER_SPAWN_EGG = registerItem("ravager_spawn_egg", (Item)new SpawnEggItem(EntityType.RAVAGER, 7697520, 5984329, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        SALMON_SPAWN_EGG = registerItem("salmon_spawn_egg", (Item)new SpawnEggItem(EntityType.SALMON, 10489616, 951412, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        SHEEP_SPAWN_EGG = registerItem("sheep_spawn_egg", (Item)new SpawnEggItem(EntityType.SHEEP, 15198183, 16758197, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        SHULKER_SPAWN_EGG = registerItem("shulker_spawn_egg", (Item)new SpawnEggItem(EntityType.SHULKER, 9725844, 5060690, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        SILVERFISH_SPAWN_EGG = registerItem("silverfish_spawn_egg", (Item)new SpawnEggItem(EntityType.SILVERFISH, 7237230, 3158064, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        SKELETON_SPAWN_EGG = registerItem("skeleton_spawn_egg", (Item)new SpawnEggItem(EntityType.SKELETON, 12698049, 4802889, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        SKELETON_HORSE_SPAWN_EGG = registerItem("skeleton_horse_spawn_egg", (Item)new SpawnEggItem(EntityType.SKELETON_HORSE, 6842447, 15066584, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        SLIME_SPAWN_EGG = registerItem("slime_spawn_egg", (Item)new SpawnEggItem(EntityType.SLIME, 5349438, 8306542, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        SPIDER_SPAWN_EGG = registerItem("spider_spawn_egg", (Item)new SpawnEggItem(EntityType.SPIDER, 3419431, 11013646, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        SQUID_SPAWN_EGG = registerItem("squid_spawn_egg", (Item)new SpawnEggItem(EntityType.SQUID, 2243405, 7375001, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        STRAY_SPAWN_EGG = registerItem("stray_spawn_egg", (Item)new SpawnEggItem(EntityType.STRAY, 6387319, 14543594, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        TRADER_LLAMA_SPAWN_EGG = registerItem("trader_llama_spawn_egg", (Item)new SpawnEggItem(EntityType.TRADER_LLAMA, 15377456, 4547222, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        TROPICAL_FISH_SPAWN_EGG = registerItem("tropical_fish_spawn_egg", (Item)new SpawnEggItem(EntityType.TROPICAL_FISH, 15690005, 16775663, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        TURTLE_SPAWN_EGG = registerItem("turtle_spawn_egg", (Item)new SpawnEggItem(EntityType.TURTLE, 15198183, 44975, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        VEX_SPAWN_EGG = registerItem("vex_spawn_egg", (Item)new SpawnEggItem(EntityType.VEX, 8032420, 15265265, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        VILLAGER_SPAWN_EGG = registerItem("villager_spawn_egg", (Item)new SpawnEggItem(EntityType.VILLAGER, 5651507, 12422002, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        VINDICATOR_SPAWN_EGG = registerItem("vindicator_spawn_egg", (Item)new SpawnEggItem(EntityType.VINDICATOR, 9804699, 2580065, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        WANDERING_TRADER_SPAWN_EGG = registerItem("wandering_trader_spawn_egg", (Item)new SpawnEggItem(EntityType.WANDERING_TRADER, 4547222, 15377456, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        WITCH_SPAWN_EGG = registerItem("witch_spawn_egg", (Item)new SpawnEggItem(EntityType.WITCH, 3407872, 5349438, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        WITHER_SKELETON_SPAWN_EGG = registerItem("wither_skeleton_spawn_egg", (Item)new SpawnEggItem(EntityType.WITHER_SKELETON, 1315860, 4672845, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        WOLF_SPAWN_EGG = registerItem("wolf_spawn_egg", (Item)new SpawnEggItem(EntityType.WOLF, 14144467, 13545366, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ZOMBIE_SPAWN_EGG = registerItem("zombie_spawn_egg", (Item)new SpawnEggItem(EntityType.ZOMBIE, 44975, 7969893, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ZOMBIE_HORSE_SPAWN_EGG = registerItem("zombie_horse_spawn_egg", (Item)new SpawnEggItem(EntityType.ZOMBIE_HORSE, 3232308, 9945732, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ZOMBIE_PIGMAN_SPAWN_EGG = registerItem("zombie_pigman_spawn_egg", (Item)new SpawnEggItem(EntityType.ZOMBIE_PIGMAN, 15373203, 5009705, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ZOMBIE_VILLAGER_SPAWN_EGG = registerItem("zombie_villager_spawn_egg", (Item)new SpawnEggItem(EntityType.ZOMBIE_VILLAGER, 5651507, 7969893, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        EXPERIENCE_BOTTLE = registerItem("experience_bottle", (Item)new ExperienceBottleItem(new Item.Properties().tab(CreativeModeTab.TAB_MISC).rarity(Rarity.UNCOMMON)));
        FIRE_CHARGE = registerItem("fire_charge", (Item)new FireChargeItem(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        WRITABLE_BOOK = registerItem("writable_book", (Item)new WritableBookItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        WRITTEN_BOOK = registerItem("written_book", (Item)new WrittenBookItem(new Item.Properties().stacksTo(16)));
        EMERALD = registerItem("emerald", new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        ITEM_FRAME = registerItem("item_frame", (Item)new ItemFrameItem(new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        FLOWER_POT = registerBlock(Blocks.FLOWER_POT, CreativeModeTab.TAB_DECORATIONS);
        CARROT = registerItem("carrot", (Item)new ItemNameBlockItem(Blocks.CARROTS, new Item.Properties().tab(CreativeModeTab.TAB_FOOD).food(Foods.CARROT)));
        POTATO = registerItem("potato", (Item)new ItemNameBlockItem(Blocks.POTATOES, new Item.Properties().tab(CreativeModeTab.TAB_FOOD).food(Foods.POTATO)));
        ...
        MAP = registerItem("map", (Item)new EmptyMapItem(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ...
        SKELETON_SKULL = registerBlock(new StandingAndWallBlockItem(Blocks.SKELETON_SKULL, Blocks.SKELETON_WALL_SKULL, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS).rarity(Rarity.UNCOMMON)));
        WITHER_SKELETON_SKULL = registerBlock(new StandingAndWallBlockItem(Blocks.WITHER_SKELETON_SKULL, Blocks.WITHER_SKELETON_WALL_SKULL, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS).rarity(Rarity.UNCOMMON)));
        PLAYER_HEAD = registerBlock(new PlayerHeadItem(Blocks.PLAYER_HEAD, Blocks.PLAYER_WALL_HEAD, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS).rarity(Rarity.UNCOMMON)));
        ...
        CARROT_ON_A_STICK = registerItem("carrot_on_a_stick", (Item)new CarrotOnAStickItem(new Item.Properties().durability(25).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        NETHER_STAR = registerItem("nether_star", (Item)new SimpleFoiledItem(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS).rarity(Rarity.UNCOMMON)));
        PUMPKIN_PIE = registerItem("pumpkin_pie", new Item(new Item.Properties().tab(CreativeModeTab.TAB_FOOD).food(Foods.PUMPKIN_PIE)));
        FIREWORK_ROCKET = registerItem("firework_rocket", (Item)new FireworkRocketItem(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        FIREWORK_STAR = registerItem("firework_star", (Item)new FireworkStarItem(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ENCHANTED_BOOK = registerItem("enchanted_book", (Item)new EnchantedBookItem(new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
        ...
        TNT_MINECART = registerItem("tnt_minecart", (Item)new MinecartItem(AbstractMinecart.Type.TNT, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        HOPPER_MINECART = registerItem("hopper_minecart", (Item)new MinecartItem(AbstractMinecart.Type.HOPPER, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        ...
        RABBIT_STEW = registerItem("rabbit_stew", (Item)new BowlFoodItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_FOOD).food(Foods.RABBIT_STEW)));
        ...
        ARMOR_STAND = registerItem("armor_stand", (Item)new ArmorStandItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        IRON_HORSE_ARMOR = registerItem("iron_horse_armor", (Item)new HorseArmorItem(5, "iron", new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        GOLDEN_HORSE_ARMOR = registerItem("golden_horse_armor", (Item)new HorseArmorItem(7, "gold", new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        DIAMOND_HORSE_ARMOR = registerItem("diamond_horse_armor", (Item)new HorseArmorItem(11, "diamond", new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        LEATHER_HORSE_ARMOR = registerItem("leather_horse_armor", (Item)new DyeableHorseArmorItem(3, "leather", new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        LEAD = registerItem("lead", (Item)new LeadItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        NAME_TAG = registerItem("name_tag", (Item)new NameTagItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        COMMAND_BLOCK_MINECART = registerItem("command_block_minecart", (Item)new MinecartItem(AbstractMinecart.Type.COMMAND_BLOCK, new Item.Properties().stacksTo(1)));
        ...
        WHITE_BANNER = registerItem("white_banner", (Item)new BannerItem(Blocks.WHITE_BANNER, Blocks.WHITE_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        ORANGE_BANNER = registerItem("orange_banner", (Item)new BannerItem(Blocks.ORANGE_BANNER, Blocks.ORANGE_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        MAGENTA_BANNER = registerItem("magenta_banner", (Item)new BannerItem(Blocks.MAGENTA_BANNER, Blocks.MAGENTA_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        LIGHT_BLUE_BANNER = registerItem("light_blue_banner", (Item)new BannerItem(Blocks.LIGHT_BLUE_BANNER, Blocks.LIGHT_BLUE_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        YELLOW_BANNER = registerItem("yellow_banner", (Item)new BannerItem(Blocks.YELLOW_BANNER, Blocks.YELLOW_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        LIME_BANNER = registerItem("lime_banner", (Item)new BannerItem(Blocks.LIME_BANNER, Blocks.LIME_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        PINK_BANNER = registerItem("pink_banner", (Item)new BannerItem(Blocks.PINK_BANNER, Blocks.PINK_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        GRAY_BANNER = registerItem("gray_banner", (Item)new BannerItem(Blocks.GRAY_BANNER, Blocks.GRAY_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        LIGHT_GRAY_BANNER = registerItem("light_gray_banner", (Item)new BannerItem(Blocks.LIGHT_GRAY_BANNER, Blocks.LIGHT_GRAY_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        CYAN_BANNER = registerItem("cyan_banner", (Item)new BannerItem(Blocks.CYAN_BANNER, Blocks.CYAN_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        PURPLE_BANNER = registerItem("purple_banner", (Item)new BannerItem(Blocks.PURPLE_BANNER, Blocks.PURPLE_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        BLUE_BANNER = registerItem("blue_banner", (Item)new BannerItem(Blocks.BLUE_BANNER, Blocks.BLUE_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        BROWN_BANNER = registerItem("brown_banner", (Item)new BannerItem(Blocks.BROWN_BANNER, Blocks.BROWN_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        GREEN_BANNER = registerItem("green_banner", (Item)new BannerItem(Blocks.GREEN_BANNER, Blocks.GREEN_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        RED_BANNER = registerItem("red_banner", (Item)new BannerItem(Blocks.RED_BANNER, Blocks.RED_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        BLACK_BANNER = registerItem("black_banner", (Item)new BannerItem(Blocks.BLACK_BANNER, Blocks.BLACK_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
        END_CRYSTAL = registerItem("end_crystal", (Item)new EndCrystalItem(new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS).rarity(Rarity.RARE)));
        CHORUS_FRUIT = registerItem("chorus_fruit", (Item)new ChorusFruitItem(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS).food(Foods.CHORUS_FRUIT)));
        ...
        BEETROOT_SEEDS = registerItem("beetroot_seeds", (Item)new ItemNameBlockItem(Blocks.BEETROOTS, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
        BEETROOT_SOUP = registerItem("beetroot_soup", (Item)new BowlFoodItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_FOOD).food(Foods.BEETROOT_SOUP)));
        DRAGON_BREATH = registerItem("dragon_breath", new Item(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE).tab(CreativeModeTab.TAB_BREWING).rarity(Rarity.UNCOMMON)));
        SPLASH_POTION = registerItem("splash_potion", (Item)new SplashPotionItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_BREWING)));
        SPECTRAL_ARROW = registerItem("spectral_arrow", (Item)new SpectralArrowItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        TIPPED_ARROW = registerItem("tipped_arrow", (Item)new TippedArrowItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
        LINGERING_POTION = registerItem("lingering_potion", (Item)new LingeringPotionItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_BREWING)));
        SHIELD = registerItem("shield", (Item)new ShieldItem(new Item.Properties().durability(336).tab(CreativeModeTab.TAB_COMBAT)));
        ELYTRA = registerItem("elytra", (Item)new ElytraItem(new Item.Properties().durability(432).tab(CreativeModeTab.TAB_TRANSPORTATION).rarity(Rarity.UNCOMMON)));
        SPRUCE_BOAT = registerItem("spruce_boat", (Item)new BoatItem(Boat.Type.SPRUCE, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        BIRCH_BOAT = registerItem("birch_boat", (Item)new BoatItem(Boat.Type.BIRCH, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        JUNGLE_BOAT = registerItem("jungle_boat", (Item)new BoatItem(Boat.Type.JUNGLE, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        ACACIA_BOAT = registerItem("acacia_boat", (Item)new BoatItem(Boat.Type.ACACIA, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        DARK_OAK_BOAT = registerItem("dark_oak_boat", (Item)new BoatItem(Boat.Type.DARK_OAK, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
        ...
        KNOWLEDGE_BOOK = registerItem("knowledge_book", (Item)new KnowledgeBookItem(new Item.Properties().stacksTo(1)));
        DEBUG_STICK = registerItem("debug_stick", (Item)new DebugStickItem(new Item.Properties().stacksTo(1)));
        MUSIC_DISC_13 = registerItem("music_disc_13", (Item)new RecordItem(1, SoundEvents.MUSIC_DISC_13, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        MUSIC_DISC_CAT = registerItem("music_disc_cat", (Item)new RecordItem(2, SoundEvents.MUSIC_DISC_CAT, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        MUSIC_DISC_BLOCKS = registerItem("music_disc_blocks", (Item)new RecordItem(3, SoundEvents.MUSIC_DISC_BLOCKS, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        MUSIC_DISC_CHIRP = registerItem("music_disc_chirp", (Item)new RecordItem(4, SoundEvents.MUSIC_DISC_CHIRP, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        MUSIC_DISC_FAR = registerItem("music_disc_far", (Item)new RecordItem(5, SoundEvents.MUSIC_DISC_FAR, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        MUSIC_DISC_MALL = registerItem("music_disc_mall", (Item)new RecordItem(6, SoundEvents.MUSIC_DISC_MALL, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        MUSIC_DISC_MELLOHI = registerItem("music_disc_mellohi", (Item)new RecordItem(7, SoundEvents.MUSIC_DISC_MELLOHI, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        MUSIC_DISC_STAL = registerItem("music_disc_stal", (Item)new RecordItem(8, SoundEvents.MUSIC_DISC_STAL, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        MUSIC_DISC_STRAD = registerItem("music_disc_strad", (Item)new RecordItem(9, SoundEvents.MUSIC_DISC_STRAD, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        MUSIC_DISC_WARD = registerItem("music_disc_ward", (Item)new RecordItem(10, SoundEvents.MUSIC_DISC_WARD, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        MUSIC_DISC_11 = registerItem("music_disc_11", (Item)new RecordItem(11, SoundEvents.MUSIC_DISC_11, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        MUSIC_DISC_WAIT = registerItem("music_disc_wait", (Item)new RecordItem(12, SoundEvents.MUSIC_DISC_WAIT, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        TRIDENT = registerItem("trident", (Item)new TridentItem(new Item.Properties().durability(250).tab(CreativeModeTab.TAB_COMBAT)));
        ...
        CROSSBOW = registerItem("crossbow", (Item)new CrossbowItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_COMBAT).durability(326)));
        SUSPICIOUS_STEW = registerItem("suspicious_stew", (Item)new SuspiciousStewItem(new Item.Properties().stacksTo(1).food(Foods.SUSPICIOUS_STEW)));
        LOOM = registerBlock(Blocks.LOOM, CreativeModeTab.TAB_DECORATIONS);
        FLOWER_BANNER_PATTERN = registerItem("flower_banner_pattern", (Item)new BannerPatternItem(BannerPattern.FLOWER, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        CREEPER_BANNER_PATTERN = registerItem("creeper_banner_pattern", (Item)new BannerPatternItem(BannerPattern.CREEPER, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.UNCOMMON)));
        SKULL_BANNER_PATTERN = registerItem("skull_banner_pattern", (Item)new BannerPatternItem(BannerPattern.SKULL, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.UNCOMMON)));
        MOJANG_BANNER_PATTERN = registerItem("mojang_banner_pattern", (Item)new BannerPatternItem(BannerPattern.MOJANG, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.EPIC)));
        GLOBE_BANNER_PATTER = registerItem("globe_banner_pattern", (Item)new BannerPatternItem(BannerPattern.GLOBE, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        ...
        SWEET_BERRIES = registerItem("sweet_berries", (Item)new ItemNameBlockItem(Blocks.SWEET_BERRY_BUSH, new Item.Properties().tab(CreativeModeTab.TAB_FOOD).food(Foods.SWEET_BERRIES)));
