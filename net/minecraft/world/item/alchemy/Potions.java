...
public class Potions {
    ...
    private static Potion register(final String string, final Potion bdy) {
        return Registry.<Potion>register(Registry.POTION, string, bdy);
    }
    
    static {
        EMPTY = register("empty", new Potion(new MobEffectInstance[0]));
