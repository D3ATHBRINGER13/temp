...
public interface RecipeSerializer<T extends Recipe<?>> {
    ...
    T fromJson(final ResourceLocation qv, final JsonObject jsonObject);
    
    T fromNetwork(final ResourceLocation qv, final FriendlyByteBuf je);
    
    void toNetwork(final FriendlyByteBuf je, final T ber);
    
    default <S extends RecipeSerializer<T>, T extends Recipe<?>> S register(final String string, final S bet) {
        return Registry.<S>register(Registry.RECIPE_SERIALIZER, string, bet);
    }
}
