...
public final class BadlandsPlateauBiome extends Biome {
    public BadlandsPlateauBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.BADLANDS, SurfaceBuilder.CONFIG_BADLANDS).precipitation(Precipitation.NONE).biomeCategory(BiomeCategory.MESA).depth(1.5f).scale(0.025f).temperature(2.0f).downfall(0.0f).waterColor(4159204).waterFogColor(329011).parent(null));
