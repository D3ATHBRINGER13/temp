...
public class BambooJungleBiome extends Biome {
    public BambooJungleBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Precipitation.RAIN).biomeCategory(BiomeCategory.JUNGLE).depth(0.1f).scale(0.2f).temperature(0.95f).downfall(0.9f).waterColor(4159204).waterFogColor(329011).parent(null));
