...
public final class BeachBiome extends Biome {
    public BeachBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_DESERT).precipitation(Precipitation.RAIN).biomeCategory(BiomeCategory.BEACH).depth(0.0f).scale(0.025f).temperature(0.8f).downfall(0.4f).waterColor(4159204).waterFogColor(329011).parent(null));
        ...
        this.addSpawn(MobCategory.CREATURE, new SpawnerData(EntityType.TURTLE, 5, 2, 5));
