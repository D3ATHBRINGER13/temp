...
public final class BirchForestHillsBiome extends Biome {
    public BirchForestHillsBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Precipitation.RAIN).biomeCategory(BiomeCategory.FOREST).depth(0.45f).scale(0.3f).temperature(0.6f).downfall(0.6f).waterColor(4159204).waterFogColor(329011).parent(null));
