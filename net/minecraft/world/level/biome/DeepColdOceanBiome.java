...
public class DeepColdOceanBiome extends Biome {
    public DeepColdOceanBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Precipitation.RAIN).biomeCategory(BiomeCategory.OCEAN).depth(-1.8f).scale(0.1f).temperature(0.5f).downfall(0.5f).waterColor(4020182).waterFogColor(329011).parent(null));
        ...
        this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Biome.<SeagrassFeatureConfiguration, NoneDecoratorConfiguration>makeComposite(Feature.SEAGRASS, new SeagrassFeatureConfiguration(40, 0.8), FeatureDecorator.TOP_SOLID_HEIGHTMAP, DecoratorConfiguration.NONE));
