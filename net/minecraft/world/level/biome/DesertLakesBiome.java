...
public final class DesertLakesBiome extends Biome {
    public DesertLakesBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_DESERT).precipitation(Precipitation.NONE).biomeCategory(BiomeCategory.DESERT).depth(0.225f).scale(0.25f).temperature(2.0f).downfall(0.0f).waterColor(4159204).waterFogColor(329011).parent("desert"));
