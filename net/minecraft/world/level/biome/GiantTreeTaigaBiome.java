...
public final class GiantTreeTaigaBiome extends Biome {
    public GiantTreeTaigaBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.GIANT_TREE_TAIGA, SurfaceBuilder.CONFIG_GRASS).precipitation(Precipitation.RAIN).biomeCategory(BiomeCategory.TAIGA).depth(0.2f).scale(0.2f).temperature(0.3f).downfall(0.8f).waterColor(4159204).waterFogColor(329011).parent(null));
