...
public final class ModifiedJungleBiome extends Biome {
    public ModifiedJungleBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Precipitation.RAIN).biomeCategory(BiomeCategory.JUNGLE).depth(0.2f).scale(0.4f).temperature(0.95f).downfall(0.9f).waterColor(4159204).waterFogColor(329011).parent("jungle"));
