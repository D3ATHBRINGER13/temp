...
public final class ShatteredSavannaBiome extends Biome {
    public ShatteredSavannaBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.SHATTERED_SAVANNA, SurfaceBuilder.CONFIG_GRASS).precipitation(Precipitation.NONE).biomeCategory(BiomeCategory.SAVANNA).depth(0.3625f).scale(1.225f).temperature(1.1f).downfall(0.0f).waterColor(4159204).waterFogColor(329011).parent("savanna"));
