...
public final class ShatteredSavannaPlateauBiome extends Biome {
    public ShatteredSavannaPlateauBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.SHATTERED_SAVANNA, SurfaceBuilder.CONFIG_GRASS).precipitation(Precipitation.NONE).biomeCategory(BiomeCategory.SAVANNA).depth(1.05f).scale(1.2125001f).temperature(1.0f).downfall(0.0f).waterColor(4159204).waterFogColor(329011).parent("savanna_plateau"));
