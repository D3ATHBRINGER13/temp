...
public final class SnowyBeachBiome extends Biome {
    public SnowyBeachBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_DESERT).precipitation(Precipitation.SNOW).biomeCategory(BiomeCategory.BEACH).depth(0.0f).scale(0.025f).temperature(0.05f).downfall(0.3f).waterColor(4020182).waterFogColor(329011).parent(null));
        ...
        this.<BuriedTreasureConfiguration>addStructureStart(Feature.BURIED_TREASURE, new BuriedTreasureConfiguration(0.01f));
        this.<ShipwreckConfiguration>addStructureStart(Feature.SHIPWRECK, new ShipwreckConfiguration(true));
