...
public final class SnowyTaigaBiome extends Biome {
    public SnowyTaigaBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Precipitation.SNOW).biomeCategory(BiomeCategory.TAIGA).depth(0.2f).scale(0.2f).temperature(-0.5f).downfall(0.4f).waterColor(4020182).waterFogColor(329011).parent(null));
