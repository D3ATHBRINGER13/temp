...
public final class SnowyTundraBiome extends Biome {
    public SnowyTundraBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Precipitation.SNOW).biomeCategory(BiomeCategory.ICY).depth(0.125f).scale(0.05f).temperature(0.0f).downfall(0.5f).waterColor(4159204).waterFogColor(329011).parent(null));
        this.<VillageConfiguration>addStructureStart(Feature.VILLAGE, new VillageConfiguration("village/snowy/town_centers", 6));
        this.<NoneFeatureConfiguration>addStructureStart(Feature.IGLOO, FeatureConfiguration.NONE);
