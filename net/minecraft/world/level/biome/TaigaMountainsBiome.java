...
public final class TaigaMountainsBiome extends Biome {
    public TaigaMountainsBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Precipitation.RAIN).biomeCategory(BiomeCategory.TAIGA).depth(0.3f).scale(0.4f).temperature(0.25f).downfall(0.8f).waterColor(4159204).waterFogColor(329011).parent("taiga"));
