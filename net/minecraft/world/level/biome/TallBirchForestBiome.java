...
public final class TallBirchForestBiome extends Biome {
    public TallBirchForestBiome() {
        super(new BiomeBuilder().<SurfaceBuilderBaseConfiguration>surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Precipitation.RAIN).biomeCategory(BiomeCategory.FOREST).depth(0.2f).scale(0.4f).temperature(0.6f).downfall(0.6f).waterColor(4159204).waterFogColor(329011).parent("birch_forest"));
