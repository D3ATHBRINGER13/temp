...
public class BlockEntityType<T extends BlockEntity> {
    ...
    @Nullable
    public static ResourceLocation getKey(final BlockEntityType<?> btx) {
        return Registry.BLOCK_ENTITY_TYPE.getKey(btx);
    }
    
    private static <T extends BlockEntity> BlockEntityType<T> register(final String string, final Builder<T> a) {
        Type<?> type3 = null;
        try {
            type3 = DataFixers.getDataFixer().getSchema(DataFixUtils.makeKey(SharedConstants.getCurrentVersion().getWorldVersion())).getChoiceType(References.BLOCK_ENTITY, string);
        }
    ...
    public boolean isValid(final Block bmv) {
        return this.validBlocks.contains(bmv);
    }
    ...
    static {
        ...
        SIGN = BlockEntityType.<SignBlockEntity>register("sign", Builder.<SignBlockEntity>of((java.util.function.Supplier<? extends SignBlockEntity>)SignBlockEntity::new, new Block[] { Blocks.OAK_SIGN, Blocks.SPRUCE_SIGN, Blocks.BIRCH_SIGN, Blocks.ACACIA_SIGN, Blocks.JUNGLE_SIGN, Blocks.DARK_OAK_SIGN, Blocks.OAK_WALL_SIGN, Blocks.SPRUCE_WALL_SIGN, Blocks.BIRCH_WALL_SIGN, Blocks.ACACIA_WALL_SIGN, Blocks.JUNGLE_WALL_SIGN, Blocks.DARK_OAK_WALL_SIGN }));
        ...
        JIGSAW = BlockEntityType.<JigsawBlockEntity>register("jigsaw", Builder.<JigsawBlockEntity>of((java.util.function.Supplier<? extends JigsawBlockEntity>)JigsawBlockEntity::new, new Block[] { Blocks.JIGSAW_BLOCK }));
        CAMPFIRE = BlockEntityType.<CampfireBlockEntity>register("campfire", Builder.<CampfireBlockEntity>of((java.util.function.Supplier<? extends CampfireBlockEntity>)CampfireBlockEntity::new, new Block[] { Blocks.CAMPFIRE }));
    }
