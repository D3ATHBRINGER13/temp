...
public class BlockInWorld {
    ...
    public BlockInWorld(final LevelReader bhu, final BlockPos ew, final boolean boolean3) {
        this.level = bhu;
    ...
    public static Predicate<BlockInWorld> hasState(final Predicate<BlockState> predicate) {
        return (Predicate<BlockInWorld>)(bvx -> bvx != null && predicate.test(bvx.getState()));
    }
}
