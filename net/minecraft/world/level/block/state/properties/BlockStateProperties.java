...
public class BlockStateProperties {
    ...
    static {
        ...
        FACING_HOPPER = DirectionProperty.create("facing", (Predicate<Direction>)(fb -> fb != Direction.UP));
        ...
        RAIL_SHAPE_STRAIGHT = EnumProperty.<RailShape>create("shape", RailShape.class, (java.util.function.Predicate<RailShape>)(bwx -> bwx != RailShape.NORTH_EAST && bwx != RailShape.NORTH_WEST && bwx != RailShape.SOUTH_EAST && bwx != RailShape.SOUTH_WEST));
