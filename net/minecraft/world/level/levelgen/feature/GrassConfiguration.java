...
public class GrassConfiguration implements FeatureConfiguration {
    ...
    public GrassConfiguration(final BlockState bvt) {
        this.state = bvt;
    }
