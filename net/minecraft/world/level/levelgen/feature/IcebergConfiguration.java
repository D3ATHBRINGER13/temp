...
public class IcebergConfiguration implements FeatureConfiguration {
    ...
    public IcebergConfiguration(final BlockState bvt) {
        this.state = bvt;
    }
