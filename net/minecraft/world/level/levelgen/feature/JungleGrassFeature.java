...
public class JungleGrassFeature extends Feature<NoneFeatureConfiguration> {
    public JungleGrassFeature(final Function<Dynamic<?>, ? extends NoneFeatureConfiguration> function) {
        super(function);
    }
    ...
    public boolean place(final LevelAccessor bhs, final ChunkGenerator<? extends ChunkGeneratorSettings> bxi, final Random random, BlockPos ew, final NoneFeatureConfiguration cdd) {
        ...
        for (int integer10 = 0; integer10 < 128; ++integer10) {
            ...
            if (bhs.isEmptyBlock(ew2) && bhs.getBlockState(ew2.below()).getBlock() != Blocks.PODZOL && bvt7.canSurvive(bhs, ew2)) {
