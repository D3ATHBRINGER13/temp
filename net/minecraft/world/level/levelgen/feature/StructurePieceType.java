...
public interface StructurePieceType {
    ...
    public static final StructurePieceType PILLAGER_OUTPOST = setPieceId(PillagerOutpostPieces.PillagerOutpostPiece::new, "PCP");
    public static final StructurePieceType VILLAGE = setPieceId(VillagePieces.VillagePiece::new, "NVi");
    ...
    StructurePiece load(final StructureManager cjp, final CompoundTag id);
    
    default StructurePieceType setPieceId(final StructurePieceType cev, final String string) {
        return Registry.<StructurePieceType>register(Registry.STRUCTURE_PIECE, string.toLowerCase(Locale.ROOT), cev);
    }
}
