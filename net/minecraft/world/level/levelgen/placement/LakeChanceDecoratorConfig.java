...
public class LakeChanceDecoratorConfig implements DecoratorConfiguration {
    ...
    public LakeChanceDecoratorConfig(final int integer) {
        this.chance = integer;
    }
    ...
    public static LakeChanceDecoratorConfig deserialize(final Dynamic<?> dynamic) {
        final int integer2 = dynamic.get("chance").asInt(0);
        return new LakeChanceDecoratorConfig(integer2);
    }
}
