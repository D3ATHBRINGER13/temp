...
public class BlockLightSectionStorage extends LayerLightSectionStorage<BlockDataLayerStorageMap> {
    protected BlockLightSectionStorage(final LightChunkGetter bxv) {
        super(LightLayer.BLOCK, bxv, new BlockDataLayerStorageMap((Long2ObjectOpenHashMap<DataLayer>)new Long2ObjectOpenHashMap()));
    }
    
    @Override
    protected int getLightValue(final long long1) {
        final long long2 = SectionPos.blockToSection(long1);
        final DataLayer bxn6 = this.getDataLayer(long2, false);
        if (bxn6 == null) {
            return 0;
        }
