...
public abstract class DataLayerStorageMap<M extends DataLayerStorageMap<M>> {
    ...
    public DataLayer getLayer(final long long1) {
        ...
        final DataLayer bxn4 = (DataLayer)this.map.get(long1);
        if (bxn4 != null) {
            if (this.cacheEnabled) {
    ...
    public void setLayer(final long long1, final DataLayer bxn) {
        this.map.put(long1, bxn);
    }
