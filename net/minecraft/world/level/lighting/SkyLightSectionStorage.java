...
public class SkyLightSectionStorage extends LayerLightSectionStorage<SkyDataLayerStorageMap> {
    ...
    protected SkyLightSectionStorage(final LightChunkGetter bxv) {
        super(LightLayer.SKY, bxv, new SkyDataLayerStorageMap((Long2ObjectOpenHashMap<DataLayer>)new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
    ...
    protected int getLightValue(long long1) {
        ...
        DataLayer bxn9 = this.getDataLayer(a7, long2);
        if (bxn9 == null) {
            ...
            while (bxn9 == null) {
                ...
                bxn9 = this.getDataLayer(a7, long2);
            }
        }
        return bxn9.get(SectionPos.sectionRelative(BlockPos.getX(long1)), SectionPos.sectionRelative(BlockPos.getY(long1)), SectionPos.sectionRelative(BlockPos.getZ(long1)));
    }
    ...
    protected DataLayer createDataLayer(final long long1) {
        ...
        DataLayer bxn5;
        while ((bxn5 = this.getDataLayer(long2, true)) == null) {
            long2 = SectionPos.offset(long2, Direction.UP);
        }
        return new DataLayer(new FlatDataLayer(bxn5, 0).getData());
    }
    
    @Override
    protected void markNewInconsistencies(final LayerLightEngine<SkyDataLayerStorageMap, ?> cky, final boolean boolean2, final boolean boolean3) {
        super.markNewInconsistencies(cky, boolean2, boolean3);
        if (!boolean2) {
            return;
        }
        if (!this.sectionsToAddSourcesTo.isEmpty()) {
            for (final long long6 : this.sectionsToAddSourcesTo) {
                ...
                if (integer8 == 1) {
                    ...
                    for (final Direction fb15 : SkyLightSectionStorage.HORIZONTALS) {
                        final long long7 = SectionPos.offset(long6, fb15);
                            ...
                            if (this.storingLightForSection(long7)) {
                                for (int integer12 = 0; integer12 < 16; ++integer12) {
                                    for (int integer13 = 0; integer13 < 16; ++integer13) {
                                        ...
                                        cky.checkEdge(long8, long9, cky.computeLevelFromNeighbor(long8, long9, 0), true);
                                    }
                                }
                            }
                        }
                    ...
                    for (int integer14 = 0; integer14 < 16; ++integer14) {
                        for (int integer15 = 0; integer15 < 16; ++integer15) {
                            ...
                            cky.checkEdge(long10, long7, cky.computeLevelFromNeighbor(long10, long7, 0), true);
                        }
                    }
                }
                else {
                    for (int integer9 = 0; integer9 < 16; ++integer9) {
                        for (int integer10 = 0; integer10 < 16; ++integer10) {
                            ...
                            cky.checkEdge(Long.MAX_VALUE, long11, 0, true);
                        }
                    }
                }
            }
                ...
                if (this.sectionsWithSources.remove(long6)) {
                    ...
                    for (int integer8 = 0; integer8 < 16; ++integer8) {
                        for (int integer9 = 0; integer9 < 16; ++integer9) {
                            ...
                            cky.checkEdge(Long.MAX_VALUE, long12, 15, false);
                        }
                    }
                }
            }
