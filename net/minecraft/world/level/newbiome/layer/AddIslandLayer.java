...
public enum AddIslandLayer implements BishopTransformer {
    ...
    public int apply(final Context cly, final int integer2, final int integer3, final int integer4, final int integer5, final int integer6) {
        if (!Layers.isShallowOcean(integer6) || (Layers.isShallowOcean(integer5) && Layers.isShallowOcean(integer4) && Layers.isShallowOcean(integer2) && Layers.isShallowOcean(integer3))) {
            if (!Layers.isShallowOcean(integer6) && (Layers.isShallowOcean(integer5) || Layers.isShallowOcean(integer2) || Layers.isShallowOcean(integer4) || Layers.isShallowOcean(integer3)) && cly.nextRandom(5) == 0) {
        ...
        int integer7 = 1;
        int integer8 = 1;
        if (!Layers.isShallowOcean(integer5) && cly.nextRandom(integer7++) == 0) {
            integer8 = integer5;
        }
        if (!Layers.isShallowOcean(integer4) && cly.nextRandom(integer7++) == 0) {
            integer8 = integer4;
        }
        if (!Layers.isShallowOcean(integer2) && cly.nextRandom(integer7++) == 0) {
            integer8 = integer2;
        }
        if (!Layers.isShallowOcean(integer3) && cly.nextRandom(integer7++) == 0) {
            integer8 = integer3;
        }
        if (cly.nextRandom(3) == 0) {
            return integer8;
        }
