...
public interface CastleTransformer extends AreaTransformer1, DimensionOffset1Transformer {
    ...
    default int applyPixel(final BigContext<?> clx, final Area clt, final int integer3, final int integer4) {
        return this.apply(clx, clt.get(this.getParentX(integer3 + 1), this.getParentY(integer4 + 0)), clt.get(this.getParentX(integer3 + 2), this.getParentY(integer4 + 1)), clt.get(this.getParentX(integer3 + 1), this.getParentY(integer4 + 2)), clt.get(this.getParentX(integer3 + 0), this.getParentY(integer4 + 1)), clt.get(this.getParentX(integer3 + 1), this.getParentY(integer4 + 1)));
    }
}
