...
public class MapDecoration {
    ...
    public MapDecoration(final Type a, final byte byte2, final byte byte3, final byte byte4, @Nullable final Component jo) {
        this.type = a;
        this.x = byte2;
        this.y = byte3;
        this.rot = byte4;
    ...
    public boolean equals(final Object object) {
        ...
        final MapDecoration coe3 = (MapDecoration)object;
        return this.type == coe3.type && this.rot == coe3.rot && this.x == coe3.x && this.y == coe3.y && Objects.equals(this.name, coe3.name);
    }
