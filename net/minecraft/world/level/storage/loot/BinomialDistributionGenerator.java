...
public final class BinomialDistributionGenerator implements RandomIntGenerator {
    ...
    public static class Serializer implements JsonDeserializer<BinomialDistributionGenerator>, JsonSerializer<BinomialDistributionGenerator> {
        ...
        public JsonElement serialize(final BinomialDistributionGenerator cou, final Type type, final JsonSerializationContext jsonSerializationContext) {
            final JsonObject jsonObject5 = new JsonObject();
            jsonObject5.addProperty("n", (Number)cou.n);
            jsonObject5.addProperty("p", (Number)cou.p);
