...
public final class ConstantIntValue implements RandomIntGenerator {
    ...
    public static class Serializer implements JsonDeserializer<ConstantIntValue>, JsonSerializer<ConstantIntValue> {
        ...
        public JsonElement serialize(final ConstantIntValue cow, final Type type, final JsonSerializationContext jsonSerializationContext) {
            return (JsonElement)new JsonPrimitive((Number)cow.value);
        }
    }
}
