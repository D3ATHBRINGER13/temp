...
public class RandomIntGenerators {
    ...
    public static JsonElement serialize(final RandomIntGenerator cpe, final JsonSerializationContext jsonSerializationContext) {
        final JsonElement jsonElement3 = jsonSerializationContext.serialize(cpe);
        if (jsonElement3.isJsonObject()) {
            jsonElement3.getAsJsonObject().addProperty("type", cpe.getType().toString());
        }
        return jsonElement3;
    }
