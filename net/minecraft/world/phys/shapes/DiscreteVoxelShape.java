...
public abstract class DiscreteVoxelShape {
    ...
    public boolean isFullWide(final AxisCycle ev, final int integer2, final int integer3, final int integer4) {
        return this.isFullWide(ev.cycle(integer2, integer3, integer4, Direction.Axis.X), ev.cycle(integer2, integer3, integer4, Direction.Axis.Y), ev.cycle(integer2, integer3, integer4, Direction.Axis.Z));
    }
    ...
    public boolean isFull(final AxisCycle ev, final int integer2, final int integer3, final int integer4) {
        return this.isFull(ev.cycle(integer2, integer3, integer4, Direction.Axis.X), ev.cycle(integer2, integer3, integer4, Direction.Axis.Y), ev.cycle(integer2, integer3, integer4, Direction.Axis.Z));
    }
    ...
    public int firstFull(final Direction.Axis a, final int integer2, final int integer3) {
        ...
        final AxisCycle ev8 = AxisCycle.between(Direction.Axis.X, a);
        for (int integer5 = 0; integer5 < integer4; ++integer5) {
            if (this.isFull(ev8, integer5, integer2, integer3)) {
                return integer5;
            }
        }
        return integer4;
    ...
    private void forAllAxisEdges(final IntLineConsumer b, final AxisCycle ev, final boolean boolean3) {
        final AxisCycle ev2 = ev.inverse();
        final int integer7 = this.getSize(ev2.cycle(Direction.Axis.X));
        final int integer8 = this.getSize(ev2.cycle(Direction.Axis.Y));
        final int integer9 = this.getSize(ev2.cycle(Direction.Axis.Z));
                ...
                for (int integer13 = 0; integer13 <= integer9; ++integer13) {
                    ...
                    for (int integer16 = 0; integer16 <= 1; ++integer16) {
                        for (int integer17 = 0; integer17 <= 1; ++integer17) {
                            if (this.isFullWide(ev2, integer10 + integer16 - 1, integer11 + integer17 - 1, integer13)) {
                                ++integer14;
                    ...
                    if (integer14 == 1 || integer14 == 3 || (integer14 == 2 && (integer15 & 0x1) == 0x0)) {
                        if (boolean3) {
                            ...
                            b.consume(ev2.cycle(integer10, integer11, integer13, Direction.Axis.X), ev2.cycle(integer10, integer11, integer13, Direction.Axis.Y), ev2.cycle(integer10, integer11, integer13, Direction.Axis.Z), ev2.cycle(integer10, integer11, integer13 + 1, Direction.Axis.X), ev2.cycle(integer10, integer11, integer13 + 1, Direction.Axis.Y), ev2.cycle(integer10, integer11, integer13 + 1, Direction.Axis.Z));
                        }
                    }
                    else if (integer12 != -1) {
                        b.consume(ev2.cycle(integer10, integer11, integer12, Direction.Axis.X), ev2.cycle(integer10, integer11, integer12, Direction.Axis.Y), ev2.cycle(integer10, integer11, integer12, Direction.Axis.Z), ev2.cycle(integer10, integer11, integer13, Direction.Axis.X), ev2.cycle(integer10, integer11, integer13, Direction.Axis.Y), ev2.cycle(integer10, integer11, integer13, Direction.Axis.Z));
                        integer12 = -1;
                    }
                }
            }
    ...
    public void forAllBoxes(final IntLineConsumer b, final boolean boolean2) {
        final DiscreteVoxelShape csr4 = new BitSetDiscreteVoxelShape(this);
        for (int integer5 = 0; integer5 <= this.xSize; ++integer5) {
            for (int integer6 = 0; integer6 <= this.ySize; ++integer6) {
                ...
                for (int integer8 = 0; integer8 <= this.zSize; ++integer8) {
                    if (csr4.isFullWide(integer5, integer6, integer8)) {
                        if (boolean2) {
                            if (integer7 == -1) {
                                integer7 = integer8;
                            }
                        ...
                        csr4.setZStrip(integer7, integer8, integer5, integer6, false);
                        while (csr4.isZStripFull(integer7, integer8, integer9 - 1, integer11)) {
                            csr4.setZStrip(integer7, integer8, integer9 - 1, integer11, false);
                            --integer9;
                        }
                        while (csr4.isZStripFull(integer7, integer8, integer10 + 1, integer11)) {
                            csr4.setZStrip(integer7, integer8, integer10 + 1, integer11, false);
                            ++integer10;
                        }
                        while (csr4.isXZRectangleFull(integer9, integer10 + 1, integer7, integer8, integer11 - 1)) {
                            for (int integer13 = integer9; integer13 <= integer10; ++integer13) {
                                csr4.setZStrip(integer7, integer8, integer13, integer11 - 1, false);
                            }
                            --integer11;
                        }
                        while (csr4.isXZRectangleFull(integer9, integer10 + 1, integer7, integer8, integer12 + 1)) {
                            for (int integer13 = integer9; integer13 <= integer10; ++integer13) {
                                csr4.setZStrip(integer7, integer8, integer13, integer12 + 1, false);
                            }
                            ++integer12;
                        }
    ...
    private void forAllAxisFaces(final IntFaceConsumer a, final AxisCycle ev) {
        final AxisCycle ev2 = ev.inverse();
        final Direction.Axis a2 = ev2.cycle(Direction.Axis.Z);
        final int integer6 = this.getSize(ev2.cycle(Direction.Axis.X));
        final int integer7 = this.getSize(ev2.cycle(Direction.Axis.Y));
        final int integer8 = this.getSize(a2);
        final Direction fb9 = Direction.fromAxisAndDirection(a2, Direction.AxisDirection.NEGATIVE);
        final Direction fb10 = Direction.fromAxisAndDirection(a2, Direction.AxisDirection.POSITIVE);
        for (int integer9 = 0; integer9 < integer6; ++integer9) {
            for (int integer10 = 0; integer10 < integer7; ++integer10) {
                boolean boolean13 = false;
                for (int integer11 = 0; integer11 <= integer8; ++integer11) {
                    final boolean boolean14 = integer11 != integer8 && this.isFull(ev2, integer9, integer10, integer11);
                    if (!boolean13 && boolean14) {
                        a.consume(fb9, ev2.cycle(integer9, integer10, integer11, Direction.Axis.X), ev2.cycle(integer9, integer10, integer11, Direction.Axis.Y), ev2.cycle(integer9, integer10, integer11, Direction.Axis.Z));
                    }
                    if (boolean13 && !boolean14) {
                        a.consume(fb10, ev2.cycle(integer9, integer10, integer11 - 1, Direction.Axis.X), ev2.cycle(integer9, integer10, integer11 - 1, Direction.Axis.Y), ev2.cycle(integer9, integer10, integer11 - 1, Direction.Axis.Z));
                    }
                    boolean13 = boolean14;
                }
            }
    ...
    public interface IntFaceConsumer {
        void consume(final Direction fb, final int integer2, final int integer3, final int integer4);
    }
